            ...
            lessons: [
              {
                ...
                reading: {
                  ...
                  textRu: 'В английском языке приветствия зависят от времени суток и степени формальности ситуации. "Hello" подходит везде — на работе, с друзьями или с незнакомцами. "Hi" — более непринуждённый вариант, идеальный для друзей. Утром можно сказать "Good morning." Днём говорите "Good afternoon." Вечером уместно сказать "Good evening." При первой встрече с человеком вежливо сказать "Nice to meet you." При прощании можно сказать "Goodbye" или более неформальное "Bye." Распространённый способ спросить о делах человека — "How are you?" Типичный ответ — "I\'m fine, thanks" или "I\'m good, thanks."',
                  vocab: [
              ...
              },
              {
                ...
                reading: {
                  ...
                  textRu: 'В английском алфавите 26 букв: A, B, C, D, ... Z. Умение продиктовать своё имя и адрес электронной почты очень важно. Некоторые буквы звучат похоже: B и V, M и N, или C и G. Когда кто-то спрашивает "How do you spell that?", вы называете каждую букву: "M-A-R-I-A." Для двойных букв говорите "double": "L-I-S-A, but with double L" = "L-L-I-S-A." В англоязычных странах люди часто используют слова для ясности: "A for Apple, B for Banana." Это называется фонетическим алфавитом. Он помогает при разговоре по телефону.',
                  vocab: [
              ...
              },
              {
                ...
                reading: {
                  ...
                  textRu: 'Числа повсюду: цены, возраст, номера телефонов и время. Давайте начнём с 1 до 20. One, two, three, four, five, six, seven, eight, nine, ten. Затем: eleven (11) и twelve (12) — неправильные. От 13 до 19 добавляем "-teen": thirteen, fourteen, fifteen, sixteen, seventeen, eighteen, nineteen. Обратите внимание, что "fifteen" (15) и "fifty" (50) звучат похоже — будьте внимательны! В "eight" буква "h" не читается при счёте. Для чисел вроде 21 говорим "twenty-one" через дефис. Чтобы спросить о цене, скажите "How much is it?" или "How much does it cost?"',
                  vocab: [
            ...
            lessons: [
              {
                ...
                reading: {
                  ...
                  textRu: 'Глагол "to be" — самый распространённый глагол в английском языке. Он связывает подлежащее с описанием. В настоящем времени: I am, You are, He is, She is, It is, We are, They are. В разговорной речи используются сокращения: I\'m, You\'re, He\'s, She\'s, It\'s, We\'re, They\'re. Для отрицания добавьте "not": I am not (I\'m not), You are not (You aren\'t). Для вопросов глагол ставится первым: Am I? Are you? Is he? Частые ошибки: не говорите "I am agree" — говорите "I agree" (это глагол, а не "I am agree"). Не говорите "I have 25 years" — говорите "I am 25 years old."',
                  vocab: [
              ...
              },
              {
                ...
                reading: {
                  ...
                  textRu: 'Чтобы рассказать, откуда вы, используйте "to be from" + страна: "I\'m from Brazil." Для национальности используйте прилагательное: "I\'m Brazilian." Обратите внимание на закономерности: многие национальности оканчиваются на "-an" (Italy → Italian, America → American) или "-ese" (Japan → Japanese, China → Chinese). Некоторые нерегулярны (France → French, Spain → Spanish). Чтобы спросить, откуда человек, скажите "Where are you from?" или "Where do you come from?" Оба варианта правильные. Чтобы сказать, где вы живёте сейчас, используйте "live in": "I live in Berlin." Помните: названия стран пишутся с большой буквы, но национальности в английском тоже пишутся с большой буквы!',
                  vocab: [
              ...
              },
              {
                ...
                reading: {
                  ...
                  textRu: 'Словарь по теме семьи необходим для повседневного общения. Ваша мать и отец — ваши родители (parents). Ваш брат и сестра — ваши братья и сёстры (siblings). Ваша бабушка и дедушка — ваши grandparents. Если у вас есть дети, то у вас сын (boy) или дочь (girl). Ваш муж или жена — ваш супруг (spouse). Boyfriend или girlfriend — человек, с которым вы встречаетесь. Используйте притяжательные прилагательные перед словами о семье: "my mother," "his brother," "her sister," "our parents," "their children." Чтобы спросить о семье, можно сказать "Do you have any siblings?" или "How many people are in your family?" "Only child" — человек, у которого нет братьев и сестёр.',
                  vocab: [
            ...
            lessons: [
              {
                ...
                reading: {
                  ...
                  textRu: 'В английском языке есть два распространённых способа назвать время. Цифровой способ: "It\'s three thirty" (3:30) или "It\'s seven fifteen" (7:15). Традиционный способ использует "past" и "to": "It\'s half past three" (3:30), "It\'s a quarter past seven" (7:15) или "It\'s a quarter to five" (4:45). Для времени вроде 6:10 говорим "ten past six." Для 6:50 — "ten to seven." Используйте "a.m." для утра (до полудня) и "p.m." для второй половины дня и вечера. "12 p.m." — это полдень. Чтобы спросить время, скажите "What time is it?" или "Do you have the time?" Используйте предлоги: "at" для времени на часах ("at 3 o\'clock"), "on" для дней ("on Monday"), "in" для месяцев ("in May").',
                  vocab: [
              ...
              },
              {
                ...
                reading: {
                  ...
                  textRu: 'Используйте Present Simple, чтобы говорить о привычках и ежедневной рутине. Форма простая: I work, you work, we work, they work. Но для he/she/it добавьте -s: he works, she works. Для отрицаний используйте "don\'t" или "doesn\'t": I don\'t work on Sundays. She doesn\'t drink coffee. Для вопросов используйте "Do" или "Does": Do you like tea? Does she speak English? Распространённые фразы рутины: "I get up at 7," "I have breakfast," "I go to work," "I come home at 6," "I go to bed at 11." Наречия частотности ставятся перед основным глаголом: "I always eat breakfast," "She usually wakes up early," "They sometimes go out."',
                  vocab: [
              ...
              },
              {
                ...
                reading: {
                  ...
                  textRu: 'В английском языке дни недели и месяцы всегда пишутся с большой буквы. Дни: Monday, Tuesday, Wednesday, Thursday, Friday, Saturday, Sunday. В большинстве англоязычных стран выходные — суббота и воскресенье. Месяцы: January, February, March, April, May, June, July, August, September, October, November, December. Чтобы назвать дату, используйте порядковые числительные: "the first of May" (британский вариант) или "May first" (американский вариант). Порядковые: first (1-й), second (2-й), third (3-й), fourth (4-й), fifth (5-й). Чтобы спросить дату, скажите "What\'s the date today?" или "What date is it?" "Last week" = прошлая неделя. "Next week" = следующая неделя.',
                  vocab: [
            ...
            lessons: [
              {
                ...
                reading: {
                  ...
                  textRu: 'При заказе в кафе или ресторане вежливые фразы необходимы. "Can I have a coffee, please?" — непринуждённо, но вежливо. "I\'d like the soup" — чуть более формально. "Could I get a tea?" — очень вежливо. Всегда добавляйте "please" в конце! Официант может спросить "For here or to go?" (американский вариант) или "Eat in or take away?" (британский вариант). Чтобы спросить цену, скажите "How much is it?" или "How much does it cost?" Когда закончите, попросите счёт: "The bill, please" (британский вариант) или "The check, please" (американский вариант). Для оплаты можно сказать "Can I pay by card?" или "I\'ll pay cash." Совет: в англоязычных странах принято говорить "thank you", получая заказ.',
                  vocab: [
              ...
              },
              {
                ...
                reading: {
                  ...
                  textRu: 'Когда вам нужны указания, начните вежливо: "Excuse me, where is the station?" или "Excuse me, how do I get to the museum?" Распространённые фразы для направлений: "Go straight ahead," "Turn left," "Turn right," "Take the first/second street on the left." Предлоги места играют ключевую роль: "next to" (рядом), "across from" (напротив), "between" (между двумя объектами), "behind" (позади), "in front of" (перед), "on the corner of" (на перекрёстке). Чтобы спросить о расстоянии, скажите "Is it far from here?" или "How long does it take to get there?" Ответ может быть "It\'s about 5 minutes on foot" или "It\'s a 10-minute walk." Помните: "Excuse me" — вежливый способ обратиться к незнакомцу.',
                  vocab: [
              ...
              },
              {
                ...
                reading: {
                  ...
                  textRu: 'Small talk необходим в англоязычных культурах. Погода — тема номер один для small talk! Распространённые фразы: "Lovely weather today, isn\'t it?" "It\'s a bit cold." "It\'s raining again." "The sun is finally out." Идиомы: "It\'s raining cats and dogs" = сильный дождь. "Under the weather" = плохо себя чувствовать. Другие темы для small talk: планы на выходные ("What are you up to this weekend?"), комплименты ("I love your jacket!") и еда ("Have you tried the new café?"). Распространённые ответы в small talk: "No worries" (без проблем), "Have a good one!" (дружеское прощание), "Sounds great!" (восторженное согласие), "I know, right?" (сильное согласие). Small talk — это не глубокий разговор, а дружелюбие и установление контакта.',
                  vocab: [
