    ...
    lessons: [
      {
        ...
        reading: {
          ...
          textRu: 'Каждая великая история следует структуре. Самая известная — это сюжетная дуга, состоящая из пяти ключевых этапов.\n\n**Сюжетная дуга:**\n1. Экспозиция (Exposition): начало. Мы знакомимся с персонажами, местом действия и обычным миром. "Anna lived in a small village by the sea."\n2. Развитие действия (Rising Action): события наращивают напряжение. Появляются проблемы, формируются цели, растут конфликты. "One day, a stranger arrived with a map."\n3. Кульминация (Climax): поворотный момент, момент высшего напряжения. Герой сталкивается с величайшим испытанием. "Anna confronted the stranger on the cliff."\n4. Спад действия (Falling Action): последствия кульминации. Свободные концы начинают связываться. "The stranger explained his story, and Anna understood."\n5. Развязка (Resolution): новая нормальность. История закрывается. "Anna returned to the village, changed forever."\n\n**Трёхактная структура:**\nАкт I (Setup): представьте мир, героя и завязку — событие, которое запускает историю.\nАкт II (Confrontation): герой борется, сталкивается с препятствиями и растёт.\nАкт III (Resolution): финальное столкновение и новое равновесие.\n\n**Завязка (Inciting Incident):** Это искра. Без неё нет истории. В "Harry Potter" это письмо из Хогвартса. В "The Hunger Games" это выбор Прим.\n\n**Персонаже-ориентированный vs Сюжетно-ориентированный:**\n- Character-driven: история движется благодаря тому, кто персонажи и какие выборы они делают (например, "Pride and Prejudice").\n- Plot-driven: история движется внешними событиями и действием (например, триллер или приключение).\n\n**Темп (Pacing):** Темп — это ощущение скорости истории. Короткие предложения ускоряют действие. Длинные, описательные предложения замедляют его. Используйте темп для управления эмоциями — быстро в кульминации, медленно в тихих моментах.\n\nПомните: структура — это не клетка. Это карта. Используйте её, чтобы направлять читателя, но позвольте вашей истории дышать.',
          vocab: [
      ...
      },
      {
        ...
        reading: {
          ...
          textRu: 'Персонажи — сердце вашей истории. Читатели приходят ради сюжета, но остаются ради персонажей. Убедительный персонаж ощущается как живой человек — сложный, несовершенный и меняющийся.\n\n**Элементы персонажа:**\n1. Внешнее описание: не только цвет волос и глаз. Покажите отличительные черты: шрам, привычку, походку. "He had the hands of a pianist, long and always moving."\n2. Характер: добрый ли он, жестокий, тревожный, смелый? Дайте ему черты, но избегайте стереотипов.\n3. Мотивация: чего хочет персонаж? Это двигатель истории. Персонаж без желания — плоский. "She wanted to prove her father wrong."\n4. Недостатки: идеальные персонажи скучны. Дайте им слабости: гордость, страх, нечестность, ревность. Недостатки создают конфликт и развитие.\n5. Арка персонажа: как меняется персонаж? Лучшие арки показывают трансформацию. Трус становится храбрым. Эгоист учится заботиться.\n\n**Показывай, а не рассказывай (Show, Don\'t Tell):**\nНе пишите "John was angry." Вместо этого покажите: "John slammed the door so hard the windows shook." Показ позволяет читателю прочувствовать эмоцию, а не просто узнать о ней.\n\n**Диалог как средство характеристики:**\nТо, как персонаж говорит, раскрывает, кто он. Нервный персонаж использует короткие, неуверенные предложения. Уверенный персонаж говорит длинными, плавными фразами. Выбор слов, ритм и даже молчание говорят читателю о характере.\n\n**Протагонист vs Антагонист:**\n- Протагонист: главный герой, за которого болеет читатель. Его цель движет историю.\n- Антагонист: сила или персонаж, противостоящий протагонисту. Великий антагонист не абсолютно зол — у него есть свои цели и причины.\n\n**Советы по развитию персонажа:**\n- Напишите профиль персонажа: имя, возраст, предыстория, страхи, желания, секреты.\n- Спросите: что самое худшее может случиться с этим персонажем? Затем сделайте так, чтобы это случилось.\n- Позвольте персонажам удивлять вас. Если они ощущаются живыми, они будут делать свой собственный выбор.\n\nВеликие персонажи живут в памяти читателя задолго после того, как история заканчивается.',
          vocab: [
      ...
      },
      {
        ...
        reading: {
          ...
          textRu: 'Сеттинг — это где и когда происходит ваша история. Атмосфера — как это ощущается. Вместе они переносят читателя в ваш мир. Великий сеттинг — не просто фон; он живой и влияет на всё.\n\n**Три элемента сеттинга:**\n1. Время: когда происходит история? Прошлое, настоящее, будущее? Утро или полночь? Один день или десятилетие?\n2. Место: где это происходит? Город, лес, космический корабль, кухня? Будьте конкретны — "тесная кухня с запахом старого кофе" лучше, чем просто "кухня".\n3. Настроение: какое чувство создаёт сеттинг? Лес может быть мирным или пугающим в зависимости от того, как вы его описываете.\n\n**Сенсорные детали:**\nКлюч к живому письму — задействовать чувства. Не просто описывайте, как всё выглядит — используйте все пять чувств.\n- Зрение: что вы видите? Цвета, свет, движение. "The streetlamp cast a yellow pool on the wet cobblestones."\n- Слух: что вы слышите? "A distant dog barked, then fell silent."\n- Запах: чем пахнет? Запах — самое сильное чувство для памяти. "The air tasted of salt and seaweed."\n- Осязание: что вы чувствуете? "The wind cut through her thin coat like a knife."\n- Вкус: что можно попробовать на вкус? "The coffee was bitter and too hot."\n\n**Построение мира (World-Building):**\nВ фэнтези или научной фантастике вы создаёте целые миры. Но даже в реалистичной прозе вы строите мир. Правила, история, культура и география — всё это важно. Читатель должен чувствовать, что мир существует за пределами страницы.\n\n**Атмосфера через выбор слов:**\nСлова, которые вы выбираете, создают настроение. Сравните:\n- "The house stood on the hill, old and quiet." (спокойное, нейтральное)\n- "The house crouched on the hill, dark and watching." (зловещее, угрожающее)\nТот же дом, разная атмосфера. Выбирайте глаголы, прилагательные и метафоры, соответствующие нужному настроению.\n\n**Советы:**\n- Не описывайте всё сразу. Раскрывайте сеттинг через действие.\n- Позвольте сеттингу влиять на персонажей. Дождь меняет настроение. Маленькая комната создаёт напряжение.\n- Используйте конкретные, осязаемые детали, а не расплывчатые обобщения.\n\nСеттинг — это сцена, на которой ваша история дышит.',
          vocab: [
      ...
      },
      {
        ...
        reading: {
          ...
          textRu: 'Точка зрения (POV) — это перспектива, с которой рассказывается история. Выбор POV меняет всё — что знает читатель, как он чувствует и насколько близок к персонажам. Выбирайте внимательно.\n\n**Первое лицо (I):**\nРассказчик — персонаж в истории. "I walked into the room and saw her for the first time."\n- Сильные стороны: интимность, непосредственность, сильный голос. Читатель живёт внутри головы рассказчика.\n- Слабые стороны: ограничено тем, что знает рассказчик. Рассказчик может лгать или ошибаться.\n\n**Второе лицо (You):**\nРассказчик обращается напрямую к читателю, делая "you" персонажем. "You walk into the room. You see her. Your heart stops."\n- Сильные стороны: погружение, мощь, необычность. Часто в интерактивной литературе и некоторых литературных произведениях.\n- Слабые стороны: сложно поддерживать в длинной истории. Может казаться трюком.\n\n**Третье лицо ограниченное (he/she):**\nРассказчик следует за одним персонажем, зная только его мысли и чувства. "She walked into the room. Her heart was racing, though she tried to hide it."\n- Сильные стороны: гибкость, фокус на внутреннем мире одного персонажа при некоторой дистанции.\n- Слабые стороны: ограничено одной перспективой за раз.\n\n**Третье лицо всезнающее:**\nРассказчик знает всё — мысли всех персонажей, прошлое и будущее. "She walked into the room, nervous. Across the table, he was already planning his escape."\n- Сильные стороны: божественная перспектива, может показать всё.\n- Слабые стороны: может ощущаться отстранённым. Сложно создать глубокую интимность.\n\n**Выбор правильного POV:**\n- Спросите: чья это история? POV должен принадлежать персонажу с наибольшей ставкой.\n- Первое лицо — для интимности и голоса.\n- Третье ограниченное — для гибкости с глубиной одного персонажа.\n- Всезнающее — для масштабных, многоперсонажных эпопей.\n\n**Ненадёжный рассказчик:**\nНенадёжный рассказчик — это тот, чья достоверность нарушена. Он может лгать, заблуждаться или быть психически нестабильным. Читатель должен сам выяснить правду. Известные примеры: "The Tell-Tale Heart" По и "Gone Girl." Эта техника создаёт саспенс и делает читателя активным участником.\n\nPOV — это линза, через которую читатель видит ваш мир. Выбирайте её с целью.',
          vocab: [
      ...
      },
      {
        ...
        reading: {
          ...
          textRu: 'Диалог — это то, как персонажи говорят друг с другом. Хороший диалог звучит естественно, раскрывает персонажа и движет историю вперёд. Великий диалог также имеет подтекст — смысл, скрытый за словами.\n\n**Написание естественного диалога:**\nРеальная беседа — беспорядочная. Люди используют стяжения ("don\'t," "can\'t," "I\'ll"), перебивают друг друга и не говорят полными предложениями. Хороший диалог имитирует это.\n- Используйте стяжения: "I don\'t know", а не "I do not know."\n- Допускайте перебивания: "I thought you were--" "I was."\n- Используйте диалект и акцент осторожно: это добавляет вкус, но может быть трудным для чтения. Не переборщите.\n- Позвольте персонажам иметь разные голоса. Подросток и старый профессор не должны звучать одинаково.\n\n**Авторские ремарки (Dialogue Tags):**\nРемарки говорят читателю, кто говорит.\n- "said" — невидимая ремарка. Используйте её чаще всего. Она исчезает, позволяя диалогу сиять.\n- "exclaimed," "whispered," "shouted," "muttered" — используйте, когда важны громкость или тон.\n- Избегайте чрезмерного использования креативных ремарок вроде "ejaculated," "vociferated," или "opined." Они отвлекают.\n- Действия могут заменять ремарки: "She slammed her cup down. \'I\'m done.\'" Это показывает, кто говорит, и добавляет движение.\n\n**Подтекст (Subtext):**\nПодтекст — это то, что персонаж имеет в виду, но не говорит. Это смысл под поверхностью.\n- Персонаж говорит "Fine", но имеет в виду "I\'m furious."\n- Персонаж говорит "I\'m not hungry", но имеет в виду "I\'m upset and don\'t want to talk."\nПодтекст делает диалог многослойным и реалистичным. Люди редко говорят прямо то, что имеют в виду. Они намекают, увиливают и отклоняются.\n\n**Конфликт в диалоге:**\nЛучший диалог содержит напряжение. Персонажи не соглашаются, ведут переговоры или ссорятся — даже тонко. Два персонажа, согласных во всём, — скучно. Дайте им разные цели и позвольте им столкнуться.\n\n**Советы:**\n-Читайте диалог вслух. Если он звучит неестественно, перепишите.\n- Вырезайте светскую беседу. Пропускайте "Hello, how are you?", если это не раскрывает персонажа.\n- Позвольте молчанию говорить. Пауза может быть мощнее слов.\n- Каждая реплика должна выполнять хотя бы одну задачу: раскрывать персонажа, двигать сюжет или создавать напряжение.\n\nДиалог — это действие. Делайте каждое слово значимым.',
          vocab: [
      ...
      },
      {
        ...
        reading: {
          ...
          textRu: 'Писать — значит переписывать. Ваш первый черновик — это вы рассказываете историю самому себе. Настоящая работа начинается при редактуре. Хорошая редактура превращает черновик в отполированное, мощное произведение.\n\n**Процесс редактуры:**\n1. Первый черновик: пишите без осуждения. Запишите историю. Не редактируйте на ходу — просто пишите.\n2. Редактура (крупный план): посмотрите на структуру, сюжет, арки персонажей, темп. Работает ли история? Вырезайте сцены, которые не служат ей. Добавляйте то, чего не хватает.\n3. Полировка (построчная редактура): сосредоточьтесь на предложениях, выборе слов, ритме. Это то, что заставляет прозу звучать.\n4. Корректура: исправьте опечатки, грамматику и пунктуацию. Финальная проверка.\n\n**Частые ошибки для исправления:**\n- Избыток наречий: вместо "she said angrily" покажите гнев. "She slammed her fist on the table." Наречия часто сигналят о слабых глаголах. Используйте сильные глаголы.\n- Пассивный залог: "The window was broken by the boy" слабее, чем "The boy broke the window." Активный залог обычно сильнее и яснее.\n- Цветистая проза (purple prose): чрезмерно вычурное, витиеватое письмо, привлекающее внимание к себе. "The golden orb of celestial fire descended upon the verdant meadow" следует заменить на "The sun set over the field." Ясность побеждает украшательство.\n- Клише: "dead as a doornail," "avoid like the plague." Находите свежие способы выразить мысли.\n\n**Сокращение лишних слов:**\nБольшинство черновиков можно сократить на 10-20%. Ищите:\n- Тавтологии: "past history," "unexpected surprise," "free gift."\n- Слова-заполнители: "very," "really," "just," "quite," "actually." Часто их удаление делает предложение сильнее.\n- Слабые фразы: "began to" или "started to" — обычно можно просто указать действие. "He began to run" превращается в "He ran."\n\n**Чек-лист "Показывай vs Рассказывай":**\n- Рассказывание: "John was nervous." Показывание: "John\'s hand trembled as he reached for the cup."\n- Ищите слова-эмоции (sad, angry, happy) и спрашивайте: могу ли я показать это вместо?\n- Рассказывание уместно — для переходов и резюме — но показывание создаёт погружение.\n\n**Советы по саморедактуре:**\n- Отложите черновик на день-два перед редактурой. Свежий взгляд видит больше.\n-Читайте вслух. Ваше ухо ловит то, что пропускает глаз.\n- Вырезайте всё, что не служит истории.\n- Сохраняйте вырезанное — возможно, оно пригодится в другом месте.\n- Не редактируйте и создавайте одновременно. Это разные части мозга.\n\nРедактура — это то, что превращает хорошее письмо в великое. Примите её.',
          vocab: [
