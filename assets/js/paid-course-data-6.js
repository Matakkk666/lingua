    ...
    lessons: [
      {
        ...
        reading: {
          ...
          textRu: 'Артикли — это маленькие слова, которые стоят перед существительными. В английском языке три артикля: "a", "an" и "the". Они кажутся простыми, но многие изучающие допускают с ними ошибки.\n\n**Неопределённые артикли: a / an**\nМы используем "a" перед согласным звуком и "an" перед гласным звуком. Речь о ЗВУКЕ, а не о букве!\n- a book, a car, a house, a university (звучит как "yoo")\n- an apple, an egg, an hour ("h" не читается), an umbrella\nМы используем "a/an" с исчисляемыми существительными в единственном числе, когда упоминаем что-то впервые или говорим об одном из многих: "I have a dog."\n\n**Определённый артикль: the**\nМы используем "the", когда и говорящий, и слушающий знают, о каком предмете речь. Он может быть в единственном или множественном числе.\n- "Close the door." (вы знаете, какая дверь)\n- "The sun is hot." (солнце только одно)\n- "I saw a man and a woman. The man was tall." (второе упоминание)\nМы также используем "the" с: океанами (the Atlantic), реками (the Nile), странами со словами "states/kingdom" (the UK, the USA) и превосходной степенью (the best).\n\n**Нулевой артикль (без артикля)**\nМы НЕ используем артикль с:\n- Существительными во множественном числе и неисчисляемыми для общих утверждений: "Dogs are loyal." "Water is important." (НЕ "The dogs are loyal" для общего значения)\n- Именами людей и большинства стран: "John lives in France."\n- Языками и предметами: "I study English and math."\n- Приёмами пищи: "I have breakfast at 8."\n- Днями недели и месяцами: "See you on Monday."\n\n**Частые ошибки:**\n- "I am a teacher." (профессия — используем a/an) - "She is engineer." НЕПРАВИЛЬНО! -> "She is an engineer."\n- "I like the music." (в общем) -> "I like music." (общий вкус, без артикля)\n- "The life is beautiful." НЕПРАВИЛЬНО! -> "Life is beautiful."\n- "He plays guitar." Допустимо в разговорной речи, но формально: "He plays the guitar."\n\nПрактика: Оглянитесь вокруг и составьте предложения с a, an, the и нулевым артиклем!',
          vocab: [
      ...
      },
      {
        ...
        reading: {
          ...
          textRu: 'В английском языке множественное число большинства существительных образуется добавлением -s. Но есть много исключений и неправильных форм, которые нужно выучить.\n\n**Правильные множественные:**\n1. Большинство существительных: добавьте -s\n   - book -> books, car -> cars, pen -> pens\n2. Существительные на -ch, -sh, -ss, -x, -o: добавьте -es\n   - watch -> watches, bus -> buses, box -> boxes, tomato -> tomatoes\n   - НО: photo -> photos, piano -> pianos (иностранные слова)\n3. Существительные на согласная + y: замените y -> ies\n   - city -> cities, baby -> babies, story -> stories\n   - НО: boy -> boys, day -> days (гласная + y — просто добавьте -s)\n4. Существительные на -f / -fe: замените на -ves\n   - leaf -> leaves, knife -> knives, wife -> wives\n   - НО: roof -> roofs, chief -> chiefs\n\n**Неправильные множественные (нужно запомнить):**\n- man -> men, woman -> women, child -> children\n- foot -> feet, tooth -> teeth, mouse -> mice\n- person -> people, sheep -> sheep (так же!), fish -> fish (так же!)\n\n**Неисчисляемые существительные (без множественного):**\nwater, milk, money, information, advice, news, furniture — они всегда в единственном числе: "The news is good." "I need some advice."\n\n**Указательные местоимения:**\nУказательные указывают на предметы. Они меняются в зависимости от расстояния и числа:\n- this (единственное, близко): "This is my book." (здесь, в руке)\n- these (множественное, близко): "These are my books."\n- that (единственное, далеко): "That is your car." (вон там)\n- those (множественное, далеко): "Those are your cars."\n\n**Частые ошибки:**\n- "two childs" НЕПРАВИЛЬНО! -> "two children"\n- "three womans" НЕПРАВИЛЬНО! -> "three women"\n- "I have two mouses" НЕПРАВИЛЬНО! -> "I have two mice" (для животных) или "mouses" (только для компьютерных мышей)\n- "these book" НЕПРАВИЛЬНО! -> "these books" (множественное существительное с множественным указательным)\n\nПрактика: Укажите на предметы вокруг вас и используйте this/these/that/those!',
          vocab: [
      ...
      },
      {
        ...
        reading: {
          ...
          textRu: 'Притяжательные местоимения показывают принадлежность. В английском есть притяжательные прилагательные, притяжательные местоимения и притяжательный падеж "s". Объектные местоимения заменяют существительные как дополнение в предложении.\n\n**Притяжательные прилагательные (перед существительным):**\nОни стоят ПЕРЕД существительным и показывают, кому оно принадлежит.\n- my, your, his, her, its, our, their\n- "This is my book." "Her car is red." "Our house is big."\nПримечание: они никогда не меняются! "his" для мужчины, "her" для женщины, "its" для вещи или животного.\n\n**Притяжательные местоимения (заменяют существительное):**\nОни стоят САМОСТОЯТЕЛЬНО и заменяют "прилагательное + существительное".\n- mine, yours, his, hers, ours, theirs\n- "This book is mine." (= my book)\n- "Is that car yours?" (= your car)\n- "The house is theirs." (= their house)\nПримечание: "his" одинаково как прилагательное и местоимение. Притяжательного местоимения "its" не существует — мы говорим "it" иначе.\n\n**Притяжательный падеж "s" (для людей и животных):**\nДобавьте \'s к имени или существительному для обозначения принадлежности:\n- "John\'s car" (машина, принадлежащая Джону)\n- "Mary\'s book"\n- "the dog\'s tail"\n- Для множественного числа на -s просто добавьте \': "the students\' teacher", "my parents\' house"\n- Для неправильного множественного добавьте \'s: "children\'s toys", "men\'s clothes"\n\n**Объектные местоимения (после глагола или предлога):**\nОни заменяют существительные как ДОПОЛНЕНИЕ в предложении.\n- me, you, him, her, it, us, them\n- "I love her." (не "she")\n- "Call me." (не "I")\n- "He gave it to us." (не "we")\n- "I saw them yesterday." (не "they")\n\n**Подлежащие vs Объектные местоимения:**\nПодлежащее (перед глаголом): I, you, he, she, it, we, they\nДополнение (после глагола/предлога): me, you, him, her, it, us, them\n- "She loves him." (she=подлежащее, him=дополнение)\n- "We helped them."\n\n**Частые ошибки:**\n- "This is she book." НЕПРАВИЛЬНО! -> "This is her book." (притяжательное прилагательное)\n- "This book is my." НЕПРАВИЛЬНО! -> "This book is mine." (притяжательное местоимение)\n- "I love she." НЕПРАВИЛЬНО! -> "I love her." (объектное местоимение)\n- "John car" НЕПРАВИЛЬНО! -> "John\'s car." (притяжательный падеж)\n\nПрактика: Посмотрите на вещи вокруг вас и скажите, чьи они, используя притяжательные!',
          vocab: [
      ...
      },
      {
        ...
        reading: {
          ...
          textRu: 'Эти два настоящих времени очень распространены, но изучающие часто их путают. Ключевое различие — ЧТО вы описываете: временное действие прямо сейчас или привычку/рутину.\n\n**Present Continuous (происходит СЕЙЧАС):**\nФорма: am/is/are + глагол-ing\n- "I am reading a book now."\n- "She is working at the moment."\n- "They are playing football."\nИспользуется для: действий, происходящих прямо сейчас, временных ситуаций и изменений, происходящих в данный период.\nКлючевые слова: now, right now, at the moment, currently, today, this week.\n\n**Present Simple (привычки и рутины):**\nФорма: базовый глагол (добавьте -s для he/she/it)\n- "I work every day."\n- "She plays tennis on Sundays."\n- "Water boils at 100 degrees."\nИспользуется для: привычек, рутин, постоянных ситуаций, фактов и общих истин, расписаний.\nКлючевые слова: always, usually, often, sometimes, never, every day, on Mondays, twice a week.\n\n**Различия (примеры):**\n- "I live in London." (постоянно, Present Simple) vs "I am living in London." (временно)\n- "She works here." (постоянно) vs "She is working here this month." (временно)\n- "He usually drinks coffee." (привычка) vs "He is drinking coffee now." (прямо сейчас)\n\n**Глаголы состояния (БЕЗ формы -ing):**\nНекоторые глаголы описывают СОСТОЯНИЯ, а не действия. Мы НЕ используем их с -ing:\n- like, love, hate, want, need, prefer\n- know, understand, remember, believe, think (в значении "believe")\n- see, hear, smell, taste\n- have (в значении "обладать"), own, belong\n- be, seem, appear\nПримеры:\n- "I know the answer." (НЕ "I am knowing")\n- "She wants a coffee." (НЕ "She is wanting")\n- "I have a car." (НЕ "I am having a car")\n- НО: "I am having lunch." (здесь "have" = есть, действие — ОК!)\n\n**Частые ошибки:**\n- "I am work now." НЕПРАВИЛЬНО! -> "I am working now." (continuous = am + Ving)\n- "She work every day." НЕПРАВИЛЬНО! -> "She works every day." (-s для she)\n- "I am knowing the answer." НЕПРАВИЛЬНО! -> "I know the answer." (глагол состояния)\n- "He is playing football every Sunday." НЕПРАВИЛЬНО! -> "He plays football every Sunday." (привычка = Simple)\n\nПрактика: Скажите, что вы делаете прямо сейчас и что обычно делаете каждый день!',
          vocab: [
      ...
      },
      {
        ...
        reading: {
          ...
          textRu: 'Когда мы сравниваем два или более предметов, мы используем сравнительную и превосходную степени. Форма зависит от того, какой длины прилагательное.\n\n**Сравнительная степень (сравнение ДВУХ предметов):**\n1. Короткие прилагательные (1 слог): добавьте -er\n   - tall -> taller, fast -> faster, old -> older\n   - big -> bigger (удвойте согласную после краткой гласной)\n   - nice -> nicer (просто добавьте -r после -e)\n   - hot -> hotter, big -> bigger\n2. Длинные прилагательные (2+ слога): используйте "more"\n   - beautiful -> more beautiful, expensive -> more expensive\n   - interesting -> more interesting\n   - НО: happy -> happier (согласная + y -> ier), busy -> busier\n3. Используйте "than", чтобы показать, с чем сравниваете:\n   - "Tom is taller than Bob."\n   - "This book is more interesting than that one."\n\n**Превосходная степень (сравнение ТРЁХ и более, лучший):**\n1. Короткие прилагательные: добавьте "the" + -est\n   - "the tallest", "the fastest", "the oldest"\n   - "the biggest", "the hottest"\n2. Длинные прилагательные: используйте "the most"\n   - "the most beautiful", "the most expensive"\n   - "the most interesting"\n   - "the happiest" (y -> iest)\n\n**Неправильные формы (нужно запомнить):**\n- good -> better -> the best\n- bad -> worse -> the worst\n- far -> farther/further -> the farthest/furthest\n- little -> less -> the least\n- many/much -> more -> the most\n\n**as...as (равенство):**\nИспользуйте "as + прилагательное + as", чтобы сказать, что два предмета равны:\n- "Tom is as tall as Bob." (одинаковый рост)\n- "This is as good as that."\nИспользуйте "not as...as", чтобы сказать, что что-то меньше:\n- "This is not as expensive as that one." (= менее дорогой)\n\n**Частые ошибки:**\n- "He is more taller than me." НЕПРАВИЛЬНО! -> "He is taller than me." (не используйте оба)\n- "She is the most tall." НЕПРАВИЛЬНО! -> "She is the tallest." (короткое прилагательное)\n- "This is gooder." НЕПРАВИЛЬНО! -> "This is better." (неправильная форма)\n- "He is taller that me." НЕПРАВИЛЬНО! -> "He is taller than me." (используйте "than")\n\nПрактика: Сравните предметы вокруг вас, используя сравнительную и превосходную степени!',
          vocab: [
      ...
      },
      {
        ...
        reading: {
          ...
          textRu: 'В английском есть несколько способов говорить о будущем. Два самых распространённых — "will" и "going to". Выбор правильного зависит от того, ПОЧЕМУ вы говорите о будущем.\n\n**Will (решения, предсказания, обещания):**\nФорма: will + базовый глагол (сокращение: \'ll, отрицание: won\'t)\nИспользуйте "will" для:\n1. Спонтанных решений (принятых в момент речи):\n   - "I\'m tired. I\'ll go to bed."\n   - "The phone is ringing. I\'ll answer it."\n2. Предсказаний на основе мнения или убеждения:\n   - "I think it will rain tomorrow."\n   - "People will live on Mars one day."\n3. Обещаний и предложений:\n   - "I\'ll help you with your homework."\n   - "I\'ll call you later. I promise."\n4. Фактов о будущем:\n   - "The sun will rise at 6 AM."\n\n**Going to (планы, намерения, доказательства):**\nФорма: am/is/are + going to + базовый глагол\nИспользуйте "going to" для:\n1. Планов и намерений (решённых ДО разговора):\n   - "I\'m going to study tonight." (я это запланировал)\n   - "We\'re going to travel next summer."\n2. Предсказаний на основе очевидных доказательств (вы видите это сейчас):\n   - "Look at those clouds! It\'s going to rain."\n   - "Be careful! You\'re going to fall!"\n\n**Present Continuous (договорённости на будущее):**\nИспользуйте Present Continuous для фиксированных договорённостей (с указанием времени/места):\n- "I\'m meeting John at 5." (мы договорились)\n- "She is flying to Paris tomorrow." (билет куплен)\n- "We\'re having dinner tonight."\n\n**Shall (предложения и советы):**\n"Shall" используется в основном в вопросах, особенно в британском английском:\n- "Shall I open the window?" (предложение помощи)\n- "Shall we go?" (предложение)\n- "Shall we order pizza?"\n\n**Will vs Going to (ключевое различие):**\n- Решение принято СЕЙЧАС: "I\'ll have the salad." (will)\n- Решение принято РАНЬШЕ: "I\'m going to have the salad." (я планировал заранее)\n- Предсказание по мнению: "It will rain." (я так думаю)\n- Предсказание по доказательству: "It\'s going to rain." (я вижу тёмные облака)\n\n**Частые ошибки:**\n- "I will study tonight." (если вы планировали) -> "I\'m going to study tonight."\n- "Look! It will rain." НЕПРАВИЛЬНО! -> "It\'s going to rain." (доказательство)\n- "I\'m going to the phone." (неправильно) -> "I\'ll answer the phone." (спонтанно)\n- "She wills come." НЕПРАВИЛЬНО! -> "She will come." (без -s после will)\n\nПрактика: Придумайте 3 плана на завтра (going to) и 3 спонтанных предложения (will)!',
          vocab: [
