    ...
    lessons: [
      {
        ...
        reading: {
          ...
          textRu: 'В английском языке приветствия зависят от времени суток и уровня формальности. Самое универсальное приветствие — "Hello" — оно подходит для любой ситуации. "Hi" — более расслабленный, неформальный вариант для друзей.\n\nПри приветствии утром (до 12:00) говорите "Good morning." С полудня до примерно 17:00 используйте "Good afternoon." После 17:00 уместно сказать "Good evening." "Good night" НЕ является приветствием — оно используется при прощании или перед сном.\n\nПри первой встрече с человеком скажите "Nice to meet you." Затем назовите своё имя: "Hi, my name is Maria. Nice to meet you!" Собеседник ответит: "Nice to meet you too."\n\nЧтобы спросить имя: "What is your name?" или "What\'s your name?" Чтобы спросить, откуда человек: "Where are you from?" В ответе используется конструкция "to be from": "I am from Russia" или "I\'m from Brazil."\n\nОчень распространённый способ начать беседу — "How are you?" Это вежливый вопрос, а не глубокое любопытство. Стандартные ответы: "I\'m fine, thanks," "I\'m good," "Pretty good," или "Not bad." Всегда спросите в ответ: "And you?" или "How about you?"\n\nПри прощании скажите "Goodbye" (формально) или "Bye" (неформально). Другие дружелюбные прощания: "See you later," "Take care," "Have a good day."\n\nПомните: в англоязычной культуре улыбка и зрительный контакт во время приветствия очень важны. Они демонстрируют уверенность и дружелюбие!',
          vocab: [
      ...
      },
      {
        ...
        reading: {
          ...
          textRu: 'Числа — основа повседневного общения: от определения времени до покупок, от сообщения номера телефона до обсуждения цен.\n\n**Счёт 1-20:** One, two, three, four, five, six, seven, eight, nine, ten. Затем: eleven (11) и twelve (12) — неправильные. От 13 до 19 добавляйте "-teen": thirteen, fourteen, fifteen, sixteen, seventeen, eighteen, nineteen. Будьте внимательны: "fifteen" (15) и "fifty" (50) звучат похоже!\n\n**Десятки (20-90):** Twenty, thirty, forty (без буквы "u"!), fifty, sixty, seventy, eighty, ninety. Для 21 используйте дефис: twenty-one. 100 = "one hundred." 1000 = "one thousand."\n\n**Время:** Цифровой формат: "It\'s three thirty" (3:30). Традиционный: "It\'s half past three" (3:30). Другие варианты: "a quarter past seven" (7:15), "a quarter to five" (4:45).\n\nИспользуйте "a.m." для утра (до полудня) и "p.m." для дня/вечера. 12 p.m. = полдень. Чтобы спросить время: "What time is it?"\n\n**Деньги:** Чтобы спросить о цене: "How much is it?" или "How much does it cost?" $5 = "five dollars," $12.50 = "twelve fifty."\n\n**Предлоги:** "at" для времени на часах ("at 3 o\'clock"), "on" для дней ("on Monday"), "in" для месяцев ("in May").\n\nПрактикуйте числа каждый день — они встречаются повсюду!',
          vocab: [
      ...
      },
      {
        ...
        reading: {
          ...
          textRu: 'Present Simple — самое важное время в английском языке. Мы используем его для привычек, рутины, фактов и того, что в целом верно.\n\n**Форма:** Для I, you, we, they — используйте базовую форму глагола: "I work," "you study." Для he, she, it — добавьте -s или -es: "he works," "she studies."\n\n**Орфография:** Большинство глаголов добавляют -s (work → works). Глаголы, оканчивающиеся на -ch, -sh, -ss, -x, -o, добавляют -es (watch → watches, go → goes). Согласная + y меняется на -ies (study → studies).\n\n**Отрицание:** Используйте "don\'t" для I/you/we/they. Используйте "doesn\'t" для he/she/it. "I don\'t drink coffee." "She doesn\'t smoke." После "doesn\'t" глагол возвращается к базовой форме: "He doesn\'t work" (НЕ "works").\n\n**Вопросы:** "Do you like tea?" "Does she speak English?" После "does" глагол стоит в базовой форме: "Does he work?" (НЕ "works").\n\n**Наречия частоты:** always, usually, often, sometimes, rarely, never. Они ставятся ПЕРЕД основным глаголом: "I always eat breakfast." Но ПОСЛЕ глагола "to be": "I am always happy."\n\n**Обычная рутина:** "I get up at 7," "I have breakfast," "I go to work," "I come home at 6," "I go to bed at 11."\n\nПрактика: опишите свою ежедневную рутину на английском, используя Present Simple!',
          vocab: [
      ...
      },
      {
        ...
        reading: {
          ...
          textRu: 'Поход в ресторан — одна из самых частых ситуаций, где нужен английский. Знание того, как вежливо заказать еду, просто необходимо.\n\n**Вежливый заказ:** Ключевое слово — "please." Никогда не говорите "Give me..." или "I want..." — это звучит грубо. Вместо этого используйте:\n\n- "Can I have a coffee, please?" (непринуждённо, но вежливо)\n- "I\'d like the soup, please." (чуть более формально)\n- "Could I get a tea, please?" (очень вежливо)\n\n**В ресторане:**\n- Официант поприветствует вас: "Table for two?"\n- Он спросит: "Are you ready to order?"\n- Он может спросить: "Would you like anything to drink?"\n- Во время еды: "Is everything OK?"\n- В конце: "Would you like the check?"\n\n**Ключевые вопросы:**\n- "What do you recommend?"\n- "Does this contain nuts?"\n- "Is it spicy?"\n- "Can I pay by card?"\n\n**Здесь или с собой?** В фастфуде: "For here or to go?" (США) или "Eat in or take away?" (Великобритания). "For here" = есть в ресторане. "To go" = взять с собой.\n\n**Счёт:** В Великобритании: "The bill, please." В США: "The check, please." Чаевые: 15-20% в США, 10-12,5% в Великобритании.\n\nПомните: всегда говорите "please" и "thank you!"',
          vocab: [
      ...
      },
      {
        ...
        reading: {
          ...
          textRu: 'Когда вы в незнакомом городе, умение спросить дорогу и понять объяснения просто необходимо.\n\n**Вежливое начало:** Всегда начинайте с "Excuse me." Затем спрашивайте:\n- "Excuse me, where is the station?"\n- "Excuse me, how do I get to the museum?"\n- "Excuse me, is there a pharmacy near here?"\n\n**Слова направления:**\n- "Go straight ahead" — идти вперёд\n- "Turn left" / "Turn right" — повернуть\n- "Take the first/second street on the left"\n- "Go past the bank" — пройти мимо\n\n**Предлоги места:**\n- "next to" / "beside" — рядом\n- "across from" / "opposite" — напротив\n- "between" — между\n- "behind" — позади\n- "in front of" — перед\n- "on the corner of" — на углу\n\n**Расстояние и время:**\n- "Is it far?" / "Is it far from here?"\n- "It\'s about 5 minutes on foot"\n- "It\'s a 10-minute walk"\n- "It\'s not far" / "It\'s quite close"\n\n**Транспорт:**\n- Bus, train, taxi, subway (США) / underground (Великобритания)\n- "How do I get to...?" — как добраться\n- Великобритания: "single" (в одну сторону) / "return" (туда-обратно)\n- "Departure" / "Arrival"\n- "How long does it take?" — сколько времени занимает\n\nПомните: спросить дорогу — это абсолютно нормально!',
          vocab: [
      ...
      },
      {
        ...
        reading: {
          ...
          textRu: 'Past Simple описывает завершённые действия в прошлом. Это время, которое нужно для рассказов и описания того, что произошло.\n\n**Правильные глаголы:** Добавьте -ed: work → worked, play → played, live → lived, study → studied.\n- Глаголы на -e: добавьте -d (live → lived)\n- Согласная + y: замените y на i, добавьте -ed (study → studied)\n- Гласная + y: просто добавьте -ed (play → played)\n- CVC (согласная-гласная-согласная): удвойте согласную (stop → stopped)\n\n**Неправильные глаголы:** Нужно выучить! go → went, have → had, do → did, make → made, see → saw, eat → ate, take → took, buy → bought, find → found, tell → told.\n\n**Отрицание:** Используйте "didn\'t" + базовую форму для ВСЕХ лиц: "I didn\'t go," "She didn\'t eat." Важно: после "didn\'t" нет -ed — всегда базовая форма!\n\n**Вопросы:** "Did" + подлежащее + базовая форма: "Did you go?" "Did she eat?" И снова — базовая форма после "did."\n\n**Wh- вопросы:** "Where did you go?" "What did you do?" "When did she arrive?"\n\n**Выражения времени:** yesterday, last week/month/year, two days ago, in 2020.\n\n**Глагол "to be" в прошлом:** was/were. I/he/she/it → was. You/we/they → were. "I was happy." "They were tired."\n\n**Рассказ:** "Last weekend, I went to the park. I met my friends. We played football. It was a great day!"\n\nПрактика: напишите о своих выходных, используя Past Simple!',
          vocab: [
