    ...
    lessons: [
      {
        ...
        reading: {
          ...
          textRu: 'Глаголы "ser" и "estar" — два из важнейших глаголов испанского языка. Оба означают "to be" (быть) в английском, но используются в разных контекстах. Понимание разницы необходимо для точного говорения на испанском.\n\n**Использование SER:**\n1. Идентичность: "Soy Maria." / "Eres mi amigo."\n2. Происхождение и национальность: "Soy de Mexico." / "Es argentina."\n3. Профессия: "Es medico." / "Somos profesores."\n4. Постоянные характеристики: "El cielo es azul." / "La mesa es de madera."\n5. Описание: "Es alto y delgado."\n6. Время, день, дата: "Son las tres." / "Hoy es lunes." / "Es el 15 de marzo."\n7. Принадлежность: "El coche es mio."\n8. Материал: "Es de plastico." / "Es de oro."\n9. Место событий: "La fiesta es en mi casa."\n\n**Использование ESTAR:**\n1. Физическое расположение: "Madrid esta en Espana." / "El libro esta en la mesa."\n2. Временные состояния: "Estoy cansado." / "Esta enfermo."\n3. Эмоции: "Estamos felices." / "Esta triste."\n4. Прогрессивное действие: "Estoy comiendo." / "Esta lloviendo."\n5. Семейное положение: "Esta casado." / "Estoy soltero."\n6. Результат действия: "La puerta esta abierta." / "El vaso esta roto."\n7. Временная погода: "Esta nublado hoy."\n\n**Спряжение SER:**\nyo soy, tu eres, el/ella/usted es, nosotros somos, vosotros sois, ellos/ellas/ustedes son.\n\n**Спряжение ESTAR:**\nyo estoy, tu estas, el/ella/usted esta, nosotros estamos, vosotros estais, ellos/ellas/ustedes estan.\n\n**Сложные случаи с прилагательными:**\nНекоторые прилагательные меняют значение в зависимости от использования с "ser" или "estar":\n\n- "ser aburrido" = быть скучным (характер) / "estar aburrido" = скучать (состояние)\n- "ser listo" = быть умным / "estar listo" = быть готовым\n- "ser rico" = быть богатым / "estar rico" = быть вкусным\n- "ser verde" = быть зелёным (цвет/незрелый) / "estar verde" = быть незрелым\n- "ser bueno" = быть хорошим / "estar bueno" = быть вкусным/привлекательным\n\n**Правило причастия:**\nДля описания РЕЗУЛЬТАТА действия используйте estar + причастие:\n- "La puerta esta cerrada." (дверь закрыта — результат)\n- "El trabajo esta terminado." (работа закончена)\n- "El cafe esta frio." (кофе остыл)\n\n**Частые ошибки:**\n- "Yo estoy profesor." НЕВЕРНО -> "Yo soy profesor." (профессия)\n- "Madrid es en Espana." НЕВЕРНО -> "Madrid esta en Espana." (место)\n- "Estoy de Mexico." НЕВЕРНО -> "Soy de Mexico." (происхождение)\n- "Es lloviendo." НЕВЕРНО -> "Esta lloviendo." (прогрессив)\n\n**Приём для запоминания:**\nSER = DOCTOR (Description, Occupation, Characteristic, Time, Origin, Relationship)\nESTAR = PLACE (Position, Location, Action, Condition, Emotion)\n\nС практикой разница между ser и estar становится интуитивной. Важно думать: "Это постоянное или временное?" и "Это местоположение?"',
          vocab: [
      ...
      },
      {
        ...
        reading: {
          ...
          textRu: 'Прошедшее время в испанском имеет несколько временных форм. Два важнейших для повествования — preterito indefinido и imperfecto de indicativo. Понимание разницы между ними — одна из главных трудностей для изучающих испанский.\n\n**Preterito Indefinido:**\nИспользуется для завершённых действий в прошлом с чётким началом и концом.\n\nИспользование:\n1. Точечные действия: "Ayer llegue a las tres." (вчера пришёл в 3)\n2. Последовательность событий: "Me levante, desayune y sali." (встал, позавтракал, ушёл)\n3. Действия ограниченной длительности: "Vivi en Madrid dos anos." (жил в Мадриде 2 года)\n4. Прерывающие действия: "Comia cuando llego Maria." (ел, когда пришла Мария — прерывание)\n\nПравильные спряжения:\n- -AR: hable, hablaste, hablo, hablamos, hablasteis, hablaron\n- -ER: comi, comiste, comio, comimos, comisteis, comieron\n- -IR: vivi, viviste, vivio, vivimos, vivisteis, vivieron\n\nЧастые неправильные: fui (ser/ir), estuve (estar), tuve (tener), hice (hacer), dije (decir), vine (venir), pude (poder), quise (querer), supe (saber), puse (poner).\n\n**Imperfecto de Indicativo:**\nИспользуется для описания фона, привычек и действий в процессе в прошлом.\n\nИспользование:\n1. Описания в прошлом: "La casa era grande y vieja." (дом был большим и старым)\n2. Привычки и рутины: "De nino, jugaba al futbol todos los dias." (в детстве играл каждый день)\n3. Действия в процессе: "Estaba leyendo cuando sono el telefono." (читал, когда зазвонил телефон)\n4. Возраст в прошлом: "Tenia diez anos." (мне было 10 лет)\n5. Время в прошлом: "Eran las tres." (было 3 часа)\n6. Фоновое действие: "Llovia." (шёл дождь)\n\nПравильные спряжения:\n- -AR: hablaba, hablabas, hablaba, hablabamos, hablabais, hablaban\n- -ER/-IR: comia, comias, comia, comiamos, comiais, comian\n\nНеправильные: era (ser), iba (ir), veia (ver).\n\n**Ключевое сравнение:**\n- Preterito: "Comi pizza." (съел пиццу — полностью)\n- Imperfecto: "Comia pizza." (ел пиццу — в процессе, может не закончил)\n\n- Preterito: "Llovio ayer." (вчера шёл дождь — событие)\n- Imperfecto: "Llovia cuando sali." (шёл дождь, когда я вышел — фон)\n\n- Preterito: "Fui al cine." (ходил в кино — событие)\n- Imperfecto: "Iba al cine todos los viernes." (ходил в кино каждую пятницу — привычка)\n\n**Маркеры времени:**\n- Preterito: ayer, anoche, el lunes pasado, en 2020, hace dos anos, de repente\n- Imperfecto: antes, siempre, todos los dias, menudo, mientras, cuando era nino\n\n**Сочетание (повествование):**\n"Estaba (imp.) en casa cuando de repente sono (pret.) el telefono. Conteste (pret.) y era (imp.) mi amigo. Me dijo (pret.) que llegaba (imp.) tarde."\n\nЗолотое правило: используйте imperfecto для сцены и preterito для главного действия.',
          vocab: [
      ...
      },
      {
        ...
        reading: {
          ...
          textRu: 'Сослагательное наклонение (subjuntivo) — одна из самых сложных тем испанского языка для англоговорящих, так как английский почти его не использует. Однако в испанском оно необходимо для выражения желаний, эмоций, сомнений, гипотез и рекомендаций.\n\n**Когда используется subjuntivo?**\nSubjuntivo появляется в придаточных предложениях (после "que"). Основные категории:\n\n1. **Желания и воля:** querer, desear, esperar, ojala\n   - "Quiero que vengas." (хочу, чтобы ты пришёл)\n   - "Espero que tengas exito." (надеюсь, у тебя получится)\n   - "Ojala que llueva." (если бы пошёл дождь)\n\n2. **Эмоции:** estar feliz, estar triste, gustar, sorprender\n   - "Me alegra que estes aqui." (рад, что ты здесь)\n   - "Me sorprende que digas eso." (удивляет, что ты это говоришь)\n   - "Me gusta que vengas." (нравится, что ты приходишь)\n\n3. **Сомнения и неопределённость:** dudar, no creer, no estar seguro, tal vez\n   - "Dudo que venga." (сомневаюсь, что придёт)\n   - "No creo que sea verdad." (не верю, что это правда)\n   - "Tal vez llegue manana." (может быть, приедет завтра)\n\n4. **Рекомендации и советы:** recomendar, sugerir, aconsejar\n   - "Te recomiendo que estudies." (рекомендую учиться)\n   - "El medico sugiere que descanse." (врач советует отдыхать)\n\n5. **Безличные выражения:** es importante, es necesario, es probable\n   - "Es importante que aprendas espanol." (важно, чтобы ты учил испанский)\n   - "Es necesario que vengas temprano." (необходимо прийти рано)\n\n**Спряжение presente de subjuntivo:**\nДля спряжения возьмите форму "yo" настоящего времени, уберите "-o" и добавьте:\n- -AR: -e, -es, -e, -emos, -eis, -en (hablar -> hable, hables, hable...)\n- -ER/-IR: -a, -as, -a, -amos, -ais, -an (comer -> coma, comas, coma...)\n\nПримеры:\n- hablar -> hable, hables, hable, hablemos, hablais, hablen\n- comer -> coma, comas, coma, comamos, comais, coman\n- vivir -> viva, vivas, viva, vivamos, vivais, vivan\n\n**Частые неправильные:**\n- ser -> sea, seas, sea, seamos, seais, sean\n- ir -> vaya, vayas, vaya, vayamos, vayais, vayan\n- tener -> tenga, tengas, tenga, tengamos, tengais, tengan\n- hacer -> haga, hagas, haga, hagamos, hagais, hagan\n- venir -> venga, vengas, venga, vengamos, vengais, vengan\n- dar -> de, des, de, demos, deis, den\n- estar -> este, estes, este, estemos, esteis, esten\n\n**Правило трёх шагов:**\n1. Есть два разных подлежащих? (yo quiero que TU vengas)\n2. Есть глагол желания/эмоции/сомнения/рекомендации?\n3. Если да на оба -> используйте subjuntivo после "que"\n\n**Сравнение indicativo и subjuntivo:**\n- "Creo que viene." (верю, что придёт) -> INDICATIVO (уверенность)\n- "No creo que venga." (не верю, что придёт) -> SUBJUNTIVO (сомнение)\n- "Es evidente que esta aqui." (очевидно, что здесь) -> INDICATIVO\n- "Es posible que este aqui." (возможно, что здесь) -> SUBJUNTIVO\n\nSubjuntivo осваивается с практикой. Начните с самых распространённых фраз и постепенно расширяйте использование.',
          vocab: [
      ...
      },
      {
        ...
        reading: {
          ...
          textRu: '"Por" и "para" — два предлога, которые часто путают изучающие испанский, потому что оба могут переводиться как "for" в английском. Однако они имеют совершенно разное употребление.\n\n**Использование PARA:**\nPara используется в основном для указания получателя, цели, срока и сравнения.\n\n1. **Получатель (para quien):** "Este regalo es para ti." (этот подарок для тебя)\n2. **Цель (para que):** "Estudio para aprender." (учусь, чтобы научиться)\n3. **Физическое направление:** "Voy para Madrid." (еду в Мадрид)\n4. **Срок / ограничение времени:** "Necesito el informe para manana." (нужен отчёт к завтрашнему дню)\n5. **Сравнение:** "Para su edad, es alto." (для своего возраста он высокий)\n6. **Мнение:** "Para mi, es mejor." (по-моему, лучше)\n\n**Использование POR:**\nPor используется для причины, средства, обмена, длительности и места.\n\n1. **Причина / основание:** "Gracias por tu ayuda." (спасибо за помощь)\n2. **Средство / инструмент:** "Llame por telefono." (позвонил по телефону)\n3. **Обмен / цена:** "Pague diez euros por el libro." (заплатил 10 евро за книгу)\n4. **Длительность времени:** "Estuve aqui por dos horas." (был здесь два часа)\n5. **Место (por donde):** "Pase por el parque." (прошёл через парк)\n6. **От имени:** "Hablo por mi equipo." (говорю от имени команды)\n7. **Вместо:** "Trabajo por ti hoy." (работаю за тебя сегодня)\n8. **Скорость:** "Va a cien por hora." (едет со скоростью 100 в час)\n9. **Распределение:** "Repartieron los libros por las aulas." (распределили книги по классам)\n\n**Выражения с POR:**\n- por la manana / tarde / noche (утром / днём / вечером)\n- por ejemplo (например)\n- por favor (пожалуйста)\n- por eso (поэтому)\n- por lo menos (по крайней мере)\n- por ahora (пока, на данный момент)\n- por supuesto (конечно)\n- por ultimo (наконец)\n\n**Выражения с PARA:**\n- para siempre (навсегда)\n- para que (чтобы / для того чтобы)\n\n**Ключевые сравнения:**\n- "Trabajo para Maria." = работаю на Марию (получатель)\n- "Trabajo por Maria." = работаю вместо Марии (вместо)\n\n- "El libro es para Juan." = книга для Хуана\n- "Compre el libro por Juan." = купил книгу по случаю Хуана (чтобы подарить)\n\n- "Voy para Madrid." = направляюсь в Мадрид\n- "Pase por Madrid." = проехал через Мадрид\n\n- "Para manana" = к завтрашнему дню (срок)\n- "Por la manana" = утром (привычное время)\n\n**Приём для запоминания:**\nPARA: destino, proposito, plazo (DPP)\nPOR: causa, medio, intercambio, duracion (CMID)\n\nЕсли можно заменить на "para que" -> используйте PARA.\nЕсли можно заменить на "por causa de" -> используйте POR.\n\nЛучший способ выучить — практиковаться с примерами. Со временем выбор между por y para станет естественным!',
          vocab: [
      ...
      },
      {
        ...
        reading: {
          ...
          textRu: 'Местоимения-дополнения необходимы для беглой речи на испанском. Они позволяют избежать повторений и сделать общение более естественным. Есть два основных типа: прямые дополнения (OD) и косвенные дополнения (OI).\n\n**Прямое дополнение (OD):**\nПрямое дополнение непосредственно принимает действие глагола. Отвечает на вопрос "что?" или "кто?".\n\n- "Compro el pan." -> "Lo compro." (что покупаю? el pan -> lo)\n- "Veo a Maria." -> "La veo." (кого вижу? a Maria -> la)\n- "Veo a Juan." -> "Lo veo." (a Juan -> lo)\n\n**Местоимения прямого дополнения:**\nme (me), te (te), lo (его/это, м.р.), la (её/это, ж.р.), nos (нас), os (вас), los (их, м.р.), las (их, ж.р.)\n\nПримеры:\n- "Tengo el libro." -> "Lo tengo." (у меня есть -> он у меня)\n- "Compro las manzanas." -> "Las compro."\n- "Nos ve todos los dias." (видит нас каждый день)\n\n**Косвенное дополнение (OI):**\nКосвенное дополнение указывает, кому направлено действие. Отвечает на вопрос "кому?" или "для кого?".\n\n- "Doy el libro a Maria." -> "Le doy el libro." (кому? a Maria -> le)\n- "Doy el libro a Juan." -> "Le doy el libro." (a Juan -> le)\n- "Compro flores para ti." -> "Te compro flores."\n\n**Местоимения косвенного дополнения:**\nme (мне/мной), te (тебе/тобой), le (ему/ей), nos (нам), os (вам), les (им)\n\nПримечание: OI не меняется по роду. "le" используется для мужского и женского рода.\n\n**Частые глаголы с OI:**\n- dar: "Le doy el libro." (даю ему книгу)\n- decir: "Le digo la verdad." (говорю ему правду)\n- preguntar: "Le pregunto la hora." (спрашиваю у него время)\n- enviar: "Le envio un correo." (отправляю ему письмо)\n- explicar: "Le explico el problema." (объясняю ему проблему)\n\n**Сочетание OD + OI:**\nКогда есть оба дополнения в одном предложении:\n- me lo, te lo, le lo -> se lo, nos lo, os lo, se lo\n\nВажно: "le lo" превращается в "se lo" для благозвучия.\n\nПримеры:\n- "Doy el libro a Maria." -> "Se lo doy." (le lo -> se lo)\n- "Doy las flores a Juan." -> "Se las doy."\n- "Explique el problema a ellos." -> "Se lo explique."\n- "Enseño la foto a mis padres." -> "Se la enseno."\n\n**Позиция местоимений:**\n1. Перед спрягаемым глаголом: "Lo veo." / "Le doy el libro."\n2. Слитно с инфинитивом: "Quiero verlo." / "Voy a darle el libro."\n3. Слитно с герундием: "Estoy viendolo." / "Estoy dandole el libro."\n4. Слитно с утвердительным императивом: "Compralo!" / "Dale el libro!"\n\nПримечание: с глаголами в инфинитиве или герундии местоимение может стоять до или после:\n- "Lo quiero ver." = "Quiero verlo." (оба правильны)\n- "Le estoy dando el libro." = "Estoy dandole el libro."\n\n**Персональная "a":**\nКогда OD — конкретное лицо, используется "a" перед местоимением:\n- "Veo a Maria." (вижу Марию — лицо)\n- "Veo el coche." (вижу машину — не лицо, без "a")\n\n**Частые ошибки:**\n- "Le veo" когда это OD: "Veo a Juan" -> "Lo veo" (не "le veo")\n- "Lo doy el libro a Maria" НЕВЕРНО -> "Le doy el libro" (OI, не OD)\n- Забывать про трансформацию "le lo" -> "se lo"\n\nКлюч — задать вопрос: слово принимает действие прямо (OD) или косвенно (OI)?',
          vocab: [
      ...
      },
      {
        ...
        reading: {
          ...
          textRu: 'Будущее время и условное наклонение (condicional) — две тесно связанные временные формы. Обе образуются добавлением окончаний к инфинитиву и используются для разговора о будущем и гипотетических ситуациях.\n\n**Futuro Simple:**\nИспользуется для действий, которые произойдут в будущем, предсказаний и обещаний.\n\nОбразование: инфинитив + окончания.\nОкончания: -e, -as, -a, -emos, -eis, -an (одинаковые для -ar, -er, -ir)\n\n- hablar: hablare, hablaras, hablara, hablaremos, hablareis, hablaran\n- comer: comere, comeras, comera, comeremos, comereis, comeran\n- vivir: vivire, viviras, vivira, viviremos, vivireis, viviran\n\nИспользование будущего:\n1. Будущие действия: "Manana ire al cine." (завтра пойду в кино)\n2. Предсказания: "Llovera manana." (завтра будет дождь)\n3. Обещания: "Te llamare." (позвоню тебе)\n4. Спонтанные решения: "Vale, lo hare." (хорошо, сделаю)\n5. Вероятность в настоящем: "Sera las tres." (наверное, часа три)\n\n**Неправильные глаголы будущего:**\nНекоторые глаголы меняют инфинитив:\n- tener -> tendre\n- haber -> habre\n- poder -> podre\n- querer -> querre\n- saber -> sabre\n- poner -> pondre\n- salir -> saldre\n- venir -> vendre\n- hacer -> hare\n- decir -> dire\n- valer -> valdre\n- venir -> vendre\n\n**Condicional Simple:**\nИспользуется для выражения вежливости, желаний, советов и гипотетических ситуаций.\n\nОбразование: инфинитив + окончания.\nОкончания: -ia, -ias, -ia, -iamos, -iais, -ian (одинаковые для -ar, -er, -ir)\n\n- hablar: hablaria, hablarias, hablaria, hablariamos, hablariais, hablarian\n- comer: comeria, comerias, comeria, comeriamos, comeriais, comerian\n- vivir: vivia, vivias, vivia, viviamos, viviais, vivian\n\nИспользование condicional:\n1. Вежливость: "Me gustaria un cafe." (хотел бы кофе)\n2. Желания: "Me gustaria viajar." (хотел бы путешествовать)\n3. Советы: "Deberias descansar." (тебе следует отдохнуть)\n4. Гипотезы: "Si tuviera dinero, compraria un coche." (если бы были деньги, купил бы машину)\n5. Будущее в прошедшем: "Dijo que vendria." (сказал, что придёт)\n6. Вероятность в прошлом: "Seria la una." (наверное, был час)\n\n**Неправильные глаголы condicional:**\nТе же, что и в будущем:\n- tener -> tendria\n- poder -> podria\n- querer -> querria\n- saber -> sabria\n- poner -> pondria\n- salir -> saldria\n- venir -> vendria\n- hacer -> haria\n- decir -> diria\n\n**Сравнение futuro и condicional:**\n- Futuro: "Ire al cine manana." (пойду завтра — точно)\n- Condicional: "Iria al cine si tuviera tiempo." (пошёл бы, если бы было время — гипотетически)\n\n- Futuro: "Comere pizza." (буду есть пиццу)\n- Condicional: "Comeria pizza." (съел бы пиццу — желание)\n\n- Futuro: "Llovera." (будет дождь — предсказание)\n- Condicional: "Lloveria." (был бы дождь — гипотеза)\n\n**Условные предложения (si +...):**\n- Si + presente, futuro: "Si llueve, me quedare en casa." (если будет дождь, останусь)\n- Si + imperfecto subjuntivo, condicional: "Si lloviera, me quedaria en casa." (если бы был дождь, остался бы)\n\n**Частые ошибки:**\n- "Voy a iré" НЕВЕРНО -> "Ire" (не использовать двойное будущее)\n- "Yo gustaria" НЕВЕРНО -> "Me gustaria" (использовать местоимение OI)\n- Путать "quiero" с "querria" (querer настоящее vs condicional)\n\nПрактика делает мастера. Попробуйте описать своё будущее и свои желания, используя эти временные формы!',
          vocab: [
