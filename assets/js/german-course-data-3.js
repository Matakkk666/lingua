    ...
    lessons: [
      {
        ...
        reading: {
          ...
          textRu: 'В немецком языке есть четыре падежа: номинатив, аккузатив, датив и генитив. Для начинающих важнейшие три: номинатив, аккузатив и датив.\n\n**Номинатив (кто? что?):**\nНоминатив — основной падеж. Он используется для подлежащего в предложении.\n- Der Mann liest ein Buch. (Мужчина читает книгу.)\n- Die Frau ist Lehrerin. (Женщина — учительница.)\n- Das Kind spielt. (Ребёнок играет.)\n\nВопросы: Wer? (кто?) или Was? (что?)\n\n**Аккузатив (кого? что?):**\nАккузатив используется для прямого дополнения. У мужских артиклей меняется артикль: der -> den.\n\nАртикли в аккузативе:\n- der -> den (м.р.): Ich sehe den Mann. (Я вижу мужчину.)\n- die -> die (ж.р.): Ich sehe die Frau. (Я вижу женщину.)\n- das -> das (ср.р.): Ich sehe das Kind. (Я вижу ребёнка.)\n- die -> die (мн.ч.): Ich sehe die Kinder. (Я вижу детей.)\n\nВопросы: Wen? (кого?) или Was? (что?)\n\nВажно: только мужской артикль меняется в аккузативе! Женский, средний и множественное число остаются неизменными.\n\n**Датив (кому? чему?):**\nДатив используется для косвенного дополнения. Все артикли меняются.\n\nАртикли в дативе:\n- der -> dem (м.р.): Ich gebe dem Mann ein Buch. (Я даю мужчине книгу.)\n- die -> der (ж.р.): Ich gebe der Frau ein Buch. (Я даю женщине книгу.)\n- das -> dem (ср.р.): Ich gebe dem Kind ein Buch. (Я даю ребёнку книгу.)\n- die -> den (мн.ч.): Ich gebe den Kindern Bucher. (Я даю детям книги.)\n\nВопросы: Wem? (кому?)\n\n**Предлоги с дативом:**\nМногие предлоги требуют датива:\n- aus (из): aus dem Haus\n- bei (у): bei der Frau\n- mit (с): mit dem Auto\n- nach (в/после): nach Hause\n- seit (с тех пор): seit einem Jahr\n- von (от): von dem Mann\n- zu (к): zu dem Arzt (zum Arzt)\n\n**Предлоги с аккузативом:**\n- durch (через): durch den Park\n- fur (для): fur den Mann\n- ohne (без): ohne das Buch\n- um (вокруг): um das Haus\n- gegen (против): gegen den Plan\n\n**Предлоги двойственного управления (аккузатив + датив):**\nЭти предлоги требуют аккузатив (куда?) и датив (где?):\n- in (в): in den Raum (А) / in dem Raum (D)\n- auf (на): auf den Tisch (А) / auf dem Tisch (D)\n- an (на/у): an die Wand (А) / an der Wand (D)\n- unter (под): unter den Tisch (А) / unter dem Tisch (D)\n- vor (перед): vor das Haus (А) / vor dem Haus (D)\n- hinter (за): hinter das Haus (А) / hinter dem Haus (D)\n- neben (рядом): neben den Tisch (А) / neben dem Tisch (D)\n- uber (над): uber den Tisch (А) / uber dem Tisch (D)\n\nКуда? = аккузатив (направление). Где? = датив (место).',
          vocab: [
      ...
      },
      {
        ...
        reading: {
          ...
          textRu: 'В немецком языке у каждого существительного есть фиксированный род: мужской (der), женский (die) или средний (das). Род часто нелогичен и должен изучаться с каждым словом.\n\n**Определённые артикли во всех падежах:**\n\nМужской (der):\n- Номинатив: der (der Mann)\n- Аккузатив: den (den Mann)\n- Датив: dem (dem Mann)\n- Генитив: des (des Mannes)\n\nЖенский (die):\n- Номинатив: die (die Frau)\n- Аккузатив: die (die Frau)\n- Датив: der (der Frau)\n- Генитив: der (der Frau)\n\nСредний (das):\n- Номинатив: das (das Kind)\n- Аккузатив: das (das Kind)\n- Датив: dem (dem Kind)\n- Генитив: des (des Kindes)\n\nМножественное число (die):\n- Номинатив: die (die Kinder)\n- Аккузатив: die (die Kinder)\n- Датив: den (den Kindern) — с окончанием -n!\n- Генитив: der (der Kinder)\n\n**Неопределённые артикли:**\n- ein (м. ном.): ein Mann\n- einen (м. акк.): einen Mann\n- einem (м. дат.): einem Mann\n- eines (м. ген.): eines Mannes\n\n- eine (ж. ном.): eine Frau\n- eine (ж. акк.): eine Frau\n- einer (ж. дат.): einer Frau\n- einer (ж. ген.): einer Frau\n\n- ein (ср. ном.): ein Kind\n- ein (ср. акк.): ein Kind\n- einem (ср. дат.): einem Kind\n- eines (ср. ген.): eines Kindes\n\n**Правила рода (подсказки):**\n\nМужской (der):\n- Слова на -ismus: der Tourismus, der Kapitalismus\n- Слова на -er (лица/профессии): der Lehrer, der Arzt\n- Дни, месяцы, времена года: der Montag, der Mai\n- Стороны света: der Norden, der Suden\n\nЖенский (die):\n- Слова на -ung: die Zeitung, die Wohnung\n- Слова на -heit: die Gesundheit, die Freiheit\n- Слова на -keit: die Moglichkeit, die Schwierigkeit\n- Слова на -schaft: die Freundschaft\n- Слова на -ion: die Information, die Nation\n- Слова на -tat: die Universitat, die Qualitat\n- Большинство цветов и деревьев: die Rose, die Eiche\n\nСредний (das):\n- Слова на -chen: das Madchen, das Brudchen\n- Слова на -lein: das Hauslein\n- Слова на -um: das Museum, das Zentrum\n- Инфинитивы как существительные: das Schwimmen, das Lernen\n- Большинство иностранных языков: das Englisch, das Deutsch\n\n**Важные исключения:**\n- die Sonne (солнце — ж.р.)\n- der Mond (луна — м.р.)\n- das Madchen (девочка — ср.р., так как -chen всегда среднего рода)\n- das Ende (конец — ср.р.)\n- die Hand (рука — ж.р.)',
          vocab: [
      ...
      },
      {
        ...
        reading: {
          ...
          textRu: 'Модальные глаголы выражают возможность, необходимость, желание, разрешение или способность. В немецком языке есть шесть важных модальных глаголов.\n\n**Шесть модальных глаголов:**\n1. mussen (долженствовать, быть обязанным) — необходимость\n2. konnen (мочь, уметь) — способность/возможность\n3. wollen (хотеть) — желание\n4. sollen (быть должным по поручению) — обязательство/просьба\n5. durfen (иметь разрешение) — разрешение\n6. mochten (хотеть бы) — вежливое желание\n\n**Спряжение модальных глаголов (Prasens):**\n\nmussen (долженствовать):\nich muss, du musst, er/sie/es muss, wir mussen, ihr musst, sie/Sie mussen.\n\nkonnen (мочь):\nich kann, du kannst, er/sie/es kann, wir konnen, ihr konnt, sie/Sie konnen.\n\nwollen (хотеть):\nich will, du willst, er/sie/es will, wir wollen, ihr wollt, sie/Sie wollen.\n\nsollen (быть должным):\nich soll, du sollst, er/sie/es soll, wir sollen, ihr sollt, sie/Sie sollen.\n\ndurfen (иметь разрешение):\nich darf, du darfst, er/sie/es darf, wir durfen, ihr durft, sie/Sie durfen.\n\nmochten (хотеть бы):\nich mochte, du mochtest, er/sie/es mochte, wir mochten, ihr mochtet, sie/Sie mochten.\n\n**Особенности модальных глаголов:**\n1. 1-е и 3-е лицо единственного числа не имеют окончания -t: ich muss (не: ich mosse), er kann (не: er kannt).\n2. Модальные глаголы всегда требуют инфинитива в конце предложения: Ich muss arbeiten. (Я должен работать.)\n3. Инфинитив стоит в конце предложения: Ich kann heute nicht kommen. (Я не могу прийти сегодня.)\n\n**Использование:**\n- mussen: Ich muss arbeiten. (Я должен работать.)\n- konnen: Ich kann schwimmen. (Я умею плавать.)\n- wollen: Ich will lernen. (Я хочу учиться.)\n- sollen: Ich soll das machen. (Мне поручили это сделать.)\n- durfen: Hier darf man rauchen. (Здесь можно курить.)\n- mochten: Ich mochte einen Kaffee. (Я хотел бы кофе.)\n\n**Разница mussen и sollen:**\n- mussen = внутренняя обязанность: Ich muss essen. (Я должен есть — мне это необходимо.)\n- sollen = внешнее поручение: Der Arzt sagt, ich soll ruhig bleiben. (Врач сказал, я должен сохранять спокойствие.)\n\n**Разница wollen и mochten:**\n- wollen = прямое желание: Ich will gehen. (Я хочу уйти.)\n- mochten = вежливое желание: Ich mochte einen Tee. (Я хотел бы чай.)\n\nУпражнение: составьте предложения с каждым модальным глаголом!',
          vocab: [
      ...
      },
      {
        ...
        reading: {
          ...
          textRu: 'В немецком языке есть две важные формы прошедшего времени: перфект и претеритум. Перфект используется в основном в разговорной речи, претеритум — в письменной.\n\n**Перфект:**\nПерфект образуется с помощью: вспомогательный глагол (haben/sein) + причастие II.\n\n- Ich habe gesprochen. (Я говорил.)\n- Sie hat gegessen. (Она поела.)\n- Wir sind gekommen. (Мы пришли.)\n- Er ist gegangen. (Он ушёл.)\n\n**Вспомогательный глагол haben или sein?**\n- haben: большинство глаголов (spielen, essen, trinken, lesen...)\n- sein: глаголы движения (gehen, kommen, fahren, fliegen, rennen) и глаголы изменения состояния (werden, bleiben, einschlafen)\n\n**Образование причастия II:**\nПравильные глаголы: ge- + основа + -t\n- spielen -> gespielt\n- machen -> gemacht\n- lernen -> gelernt\n\nНеправильные глаголы: ge- + основа + -en\n- sprechen -> gesprochen\n- essen -> gegessen\n- trinken -> getrunken\n- sehen -> gesehen\n- schreiben -> geschrieben\n- finden -> gefunden\n\nГлаголы с неотделяемыми приставками (be-, ver-, er-, ent-, zer-): без ge-\n- besuchen -> besucht\n- verstehen -> verstanden\n- erzahlen -> erzahlt\n\nГлаголы на -ieren: без ge-\n- studieren -> studiert\n- probieren -> probiert\n\n**Претеритум:**\nПретеритум — простое прошедшее время, в основном в письменных текстах.\n\nПравильные глаголы: основа + -te, -test, -te, -ten, -tet, -ten.\n- ich machte, du machtest, er machte, wir machten, ihr machtet, sie machten.\n\nНеправильные глаголы имеют изменение гласной:\n- sein: ich war, du warst, er war, wir waren...\n- haben: ich hatte, du hattest, er hatte...\n- gehen: ich ging, du gingst, er ging...\n- kommen: ich kam, du kamst, er kam...\n- sprechen: ich sprach, du sprachst, er sprach...\n- sehen: ich sah, du sahst, er sah...\n\n**Когда перфект, когда претеритум?**\n- Перфект: разговорная речь, беседы, неформальные тексты\n- Претеритум: письменная речь, книги, газеты, формальные тексты\n\nПример:\n- Разговорный: Ich habe gestern einen Film gesehen.\n- Письменный: Gestern sah ich einen Film.\n\nОба означают одно и то же, но контекст определяет форму.',
          vocab: [
      ...
      },
      {
        ...
        reading: {
          ...
          textRu: 'Немецкий порядок слов имеет чёткие правила. Самое важное правило: в повествовательных предложениях глагол стоит на позиции 2.\n\n**Главное предложение (повествовательное):**\nСпрягаемый глагол стоит на позиции 2.\n- Ich gehe heute ins Kino. (Я иду сегодня в кино.)\n- Heute gehe ich ins Kino. (Сегодня я иду в кино.)\n- Ins Kino gehe ich heute. (В кино я иду сегодня.)\n\nВо всех трёх предложениях глагол (gehe) стоит на позиции 2! Первый элемент может варьироваться.\n\n**Правило позиции 2:**\nПозиция 1 может быть: подлежащее, указание времени, место, дополнение и т.д.\nПозиция 2 — всегда спрягаемый глагол.\n- Gestern habe ich einen Film gesehen. (Вчера я посмотрел фильм.)\n- Am Montag fahre ich nach Berlin. (В понедельник я еду в Берлин.)\n\n**Правило TeKaMoLo:**\nЕсли есть несколько обстоятельств, действует порядок: Temporal (когда) - Kausal (почему) - Modal (как) - Lokal (куда).\n\n- Ich fahre morgen (Temporal) wegen einer Konferenz (Kausal) mit dem Zug (Modal) nach Berlin (Lokal).\n\nУпрощённо: время перед местом.\n- Ich gehe heute (Zeit) ins Kino (Ort). (не: Ich gehe ins Kino heute.)\n\n**Датив перед аккузативом:**\nЕсли есть два дополнения, дативное дополнение стоит перед аккузативным.\n- Ich gebe dem Mann (Dat) das Buch (Akk). (Я даю мужчине книгу.)\n- Ich schicke der Frau (Dat) eine Email (Akk). (Я отправляю женщине email.)\n\nНо: если аккузативное дополнение — местоимение, оно стоит перед дативом.\n- Ich gebe es (Akk-Pron.) dem Mann (Dat). (Я даю его мужчине.)\n\n**Придаточное предложение:**\nВ придаточном предложении спрягаемый глагол стоит в конце.\n- Ich denke, dass er heute kommt. (Я думаю, что он сегодня придёт.)\n- Ich weiss nicht, ob er Zeit hat. (Я не знаю, есть ли у него время.)\n- Weil ich krank bin, bleibe ich zu Hause. (Потому что я болен, я остаюсь дома.)\n\n**Вопросительные предложения:**\nОбщий вопрос (да/нет): глагол на позиции 1.\n- Kommst du heute? (Ты придёшь сегодня?)\n- Hast du Zeit? (У тебя есть время?)\n\nСпециальный вопрос: вопросительное слово на позиции 1, глагол на позиции 2.\n- Wann kommst du? (Когда ты придёшь?)\n- Wo wohnst du? (Где ты живёшь?)\n- Was machst du? (Что ты делаешь?)\n\n**Союзы и порядок слов:**\n- Und, aber, oder, denn: порядок слов не меняется (позиция 2 сохраняется).\n  Ich komme, aber ich habe wenig Zeit.\n- Weil, dass, ob: глагол в конец (придаточное).\n  Ich komme nicht, weil ich krank bin.\n\nУпражнение: составляйте собственные предложения и обращайте внимание на порядок слов!',
          vocab: [
      ...
      },
      {
        ...
        reading: {
          ...
          textRu: 'Окончания прилагательных в немецком языке — одна из самых сложных тем. Окончание зависит от рода, падежа, артикля и числа.\n\n**Три типа склонения прилагательных:**\n\n1. После определённых артиклей (der, die, das)\n2. После неопределённых артиклей (ein, eine, ein)\n3. Без артикля (нулевой артикль)\n\n**1. После определённых артиклей:**\nОкончание обычно -e или -en.\n\nНоминатив:\n- der gute Mann (м.р.)\n- die gute Frau (ж.р.)\n- das gute Kind (ср.р.)\n- die guten Kinder (мн.ч.)\n\nАккузатив:\n- den guten Mann (м.р.)\n- die gute Frau (ж.р.)\n- das gute Kind (ср.р.)\n- die guten Kinder (мн.ч.)\n\nДатив:\n- dem guten Mann (м.р.)\n- der guten Frau (ж.р.)\n- dem guten Kind (ср.р.)\n- den guten Kindern (мн.ч.)\n\nПравило: в номинативе (все) и аккузативе (ж., ср.) окончание -e. Во всех остальных случаях -en.\n\n**2. После неопределённых артиклей (ein, eine):**\nОкончание показывает род/падеж, так как артикль не всегда это показывает.\n\nНоминатив:\n- ein guter Mann (м.р.): -er\n- eine gute Frau (ж.р.): -e\n- ein gutes Kind (ср.р.): -es\n\nАккузатив:\n- einen guten Mann (м.р.): -en\n- eine gute Frau (ж.р.): -e\n- ein gutes Kind (ср.р.): -es\n\nДатив:\n- einem guten Mann (м.р.): -en\n- einer guten Frau (ж.р.): -en\n- einem guten Kind (ср.р.): -en\n\n**3. Без артикля (нулевой артикль):**\nОкончание должно полностью показывать род/падеж.\n\nНоминатив:\n- guter Mann (м.р.): -er\n- gute Frau (ж.р.): -e\n- gutes Kind (ср.р.): -es\n- gute Kinder (мн.ч.): -e\n\nАккузатив:\n- guten Mann (м.р.): -en\n- gute Frau (ж.р.): -e\n- gutes Kind (ср.р.): -es\n- gute Kinder (мн.ч.): -e\n\nДатив:\n- gutem Mann (м.р.): -em\n- guter Frau (ж.р.): -er\n- gutem Kind (ср.р.): -em\n- guten Kindern (мн.ч.): -en\n\n**Советы по изучению:**\n1. Сначала выучите окончания после определённых артиклей (самые простые).\n2. Запомните: -e в ном./акк. (ж., ср.), -en в остальных случаях.\n3. При неопределённых артиклях: аналогично нулевому артиклю, но артикль иногда показывает род.\n4. Без артикля: окончание показывает всё (-er, -e, -es, -em).\n\nСамые важные окончания: -e, -en, -er, -es, -em. С практикой они станут автоматическими.',
          vocab: [
