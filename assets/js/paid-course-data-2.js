    ...
    lessons: [
      {
        ...
        reading: {
          ...
          textRu: 'Email остаётся важнейшим средством коммуникации в бизнесе. Хорошо написанное письмо может открыть двери, выстроить отношения и предотвратить недопонимание. Плохо написанное — нанести ущерб вашей репутации.\n\n**Структура:** Каждое профессиональное письмо состоит из шести частей: тема, приветствие, вступление, основная часть, заключение и подпись. Тема критически важна — именно она определяет, будет ли ваше письмо прочитано. Делайте её короткой, конкретной и понятной: "Q3 Sales Report — Review Needed by Friday" гораздо лучше, чем "Hello" или "Important."\n\n**Приветствие:** "Dear Mr. Smith," (формально), "Dear Sarah," (полуформально) или "Hi John," (неформально, обычно среди коллег). Если вы не знаете имя, используйте "To Whom It May Concern," или "Dear Hiring Manager."\n\n**Вступление:** Переходите к делу быстро. "I am writing to inquire about...", "Following up on our meeting...", "Thank you for your prompt reply." Избегайте долгих личных новостей в формальных письмах.\n\n**Основная часть:** Используйте короткие абзацы — одна мысль на абзац. Используйте маркированные списки. Делайте предложения ясными и лаконичными. Вместо "I am writing this email in order to inform you that..." просто напишите "I would like to inform you that..."\n\n**Формальный vs. полуформальный стиль:** Формальные письма — для клиентов, внешних партнёров и высшего руководства. Используйте "I would like to," "Could you please," "Kindly." Полуформальные письма — для коллег и знакомых контактов. Используйте "Could you," "Please," "Thanks."\n\n**Заключение:** "Best regards," (универсально), "Sincerely," (формально), "Kind regards," (тёплое), "Thanks," (неформально). После — ваше полное имя, должность, компания и контактные данные.\n\n**Частые ошибки:** Не используйте заглавные буквы (IT LOOKS LIKE SHOUTING). Не злоупотребляйте "please" — это ослабляет ваше сообщение. Всегда вычитывайте перед отправкой. Отвечайте в течение 24 часов, даже если просто для подтверждения получения. Хорошее правило: если вашему письму нужно больше трёх абзацев, подумайте о встрече.',
          vocab: [
      ...
      },
      {
        ...
        reading: {
          ...
          textRu: 'Встречи — это место, где принимаются решения. Независимо от того, ведёте вы встречу или участвуете в ней, знание правильных фраз сделает вашу речь профессиональной и уверенной.\n\n**Начало встречи:** Председатель открывает: "Good morning, everyone. Thank you for coming. Let\'s get started." Затем озвучьте цель: "The purpose of today\'s meeting is to discuss the new marketing strategy." Ознакомьте с повесткой: "We have three items on the agenda today."\n\n**Участие:** Чтобы высказать мысль: "I\'d like to add that...", "In my opinion,", "From my perspective,". Чтобы согласиться: "I completely agree," "That\'s a great point," "You\'re absolutely right." Чтобы вежливо не согласиться: "I see your point, but...", "I understand what you\'re saying, however...", "With all due respect, I think..."\n\n**Внесение предложений:** "I\'d like to propose that we...", "What if we...?", "How about we try...?", "I suggest we consider..."\n\n**Фразы для переговоров:** Переговоры — это поиск решения, выгодного обеим сторонам. "What are your expectations?" "We\'re looking for..." "Could you go a bit lower?" "That\'s beyond our budget." "Can we meet halfway?" "Let me think about it." "I\'ll get back to you by Friday."\n\n**Активное слушание:** Показывайте вовлечённость: "I see," "Right," "Exactly," "That makes sense." Уточняйте: "Could you elaborate on that?" "What exactly do you mean by...?" "Let me make sure I understand — you\'re saying that...?"\n\n**Вежливое прерывание:** "Sorry to interrupt, but...", "If I could just come in here...", "Could I add something?"\n\n**Завершение встречи:** "Let\'s summarize what we\'ve agreed." "To recap, we\'ve decided that..." "Action items: John will..., Sarah will..." "Let\'s schedule the next meeting." "Thank you all for your time."\n\n**Культурный нюанс:** В англоязычной деловой культуре прямота ценится, но вежливость обязательна. Всегда признавайте чужие аргументы, прежде чем высказывать свои. Молчание допустимо — оно показывает, что вы размышляете, а не что вы согласны.',
          vocab: [
      ...
      },
      {
        ...
        reading: {
          ...
          textRu: 'Отличная презентация может убедить, вдохновить и проинформировать. Плохая — усыпить аудиторию и подорвать ваш авторитет. Ключ к успеху — подготовка и чёткая структура.\n\n**Структура:** Каждая презентация состоит из трёх частей: введение, основная часть и заключение. Введение должно привлечь внимание и обозначить тему. Основная часть раскрывает главные пункты. Заключение подводит итоги и содержит призыв к действию.\n\n**Фразы для начала:** "Good morning, everyone. Thank you for being here today." Затем представьте тему: "I\'m here to talk about..." или "Today, I\'d like to present..." Сильное начало привлекает внимание: "Did you know that 80% of startups fail within five years?"\n\n**Структурирование:** Скажите аудитории, чего ожидать: "I\'ve divided my presentation into three parts. First, I\'ll cover... Then, I\'ll discuss... Finally, I\'ll explain..."\n\n**Переходы:** Плавные переходы направляют аудиторию. "Moving on to my next point...", "That brings me to...", "Now let\'s look at...", "This leads me to my next topic..."\n\n**Визуальные материалы:** Слайды должны поддерживать, а не заменять вашу речь. Делайте их простыми: одна идея на слайд, крупный шрифт, минимум текста. "As you can see on this chart...", "This graph illustrates...", "Let me draw your attention to this figure."\n\n**Вовлечение аудитории:** Задавайте риторические вопросы: "What would happen if...?" Используйте паузы для эффекта. Устанавливайте зрительный контакт. "Raise your hand if you\'ve ever..." Поощряйте участие.\n\n**Работа с вопросами:** "That\'s a great question." "I\'m glad you asked." Если не знаете: "That\'s an interesting point. I don\'t have the exact figure right now, but I\'ll get back to you." Никогда не лгите и не выдумывайте ответы.\n\n**Заключение:** "To conclude...", "In summary,", "Let me wrap up by saying..." Завершите призывом к действию: "I encourage you to...", "The next step is...", "Thank you for your attention. Are there any questions?"\n\n**Советы:** Репетируйте вслух. Засекайте время. Подготовьтесь к вероятным вопросам. Помните: аудитория хочет вашего успеха. Волнение — это нормально — направьте его в энергию.',
          vocab: [
      ...
      },
      {
        ...
        reading: {
          ...
          textRu: 'Отчёты необходимы в бизнесе. Они сообщают о выводах, обосновывают решения и документируют прогресс. Хорошо структурированный отчёт — ясный, лаконичный и практичный.\n\n**Структура:** Стандартный деловой отчёт состоит из шести разделов: краткое резюме, введение, методология, выводы, заключения и рекомендации.\n\n**Краткое резюме (Executive Summary):** Это самая важная часть — многие читатели читают только её. Резюмируйте цель, ключевые выводы и основные рекомендации в 1-2 абзацах. Пишите его последним, хотя оно идёт первым. "This report examines... The key findings indicate... We recommend..."\n\n**Введение:** Объясните цель и охват. "The purpose of this report is to analyze..." Укажите, что охватывает отчёт и его ограничения.\n\n**Методология:** Кратко объясните, как вы собрали данные. "Data was collected through..." "We surveyed 500 customers..." "The analysis covers the period from January to June."\n\n**Выводы (Findings):** Представьте данные ясно. Используйте заголовки, маркированные списки и визуализации. Описывайте тренды: "Sales increased by 15%," "There was a significant decline in..." "The figures show a steady upward trend." "Profits remained stable throughout Q2."\n\n**Заключения:** Интерпретируйте выводы. Что они означают? "These results suggest that..." "It is clear that..." "The data indicates..."\n\n**Рекомендации:** Здесь вы добавляете ценность. Будьте конкретны и практичны. "We recommend that the company invest in..." "The marketing team should prioritize..." "Immediate action is required to..."\n\n**Стиль письма:** Используйте формальный, объективный язык. Избегайте "I think" — используйте "The analysis suggests." Используйте пассивный залог для объективности: "The data was analyzed" вместо "I analyzed the data." Делайте предложения короткими и ясными. Используйте единообразное форматирование.\n\n**Описание трендов:** Рост: "rose," "climbed," "surged." Снижение: "fell," "dropped," "declined." Стабильность: "remained steady," "leveled off." Резкое: "sharp," "dramatic." Постепенное: "steady," "moderate."\n\nВсегда вычитывайте свой отчёт. Проверьте ясность, последовательность и корректность данных.',
          vocab: [
      ...
      },
      {
        ...
        reading: {
          ...
          textRu: 'Small talk — это не "мелочь" — он выстраивает отношения, открывает двери и задаёт тон деловому общению. В англоязычных культурах small talk — важнейший деловой навык.\n\n**Почему small talk важен:** Он создаёт раппорт до перехода к делу. Люди ведут бизнес с теми, кто им нравится и кому доверяют. Несколько минут дружеской беседы могут стать решающими между успешной сделкой и холодным отказом.\n\n**Хорошие темы:**\n- Путешествия: "Did you have a good trip?" "How was your flight?"\n- Погода: "It\'s a beautiful day, isn\'t it?" "The weather\'s been great this week."\n- Место встречи: "Great venue, isn\'t it?" "Have you been here before?"\n- Мероприятие: "Are you enjoying the conference?" "What did you think of the keynote?"\n- Хобби: "What do you do in your free time?" "Do you follow any sports?"\n- Работа (в общих чертах): "What brings you to this event?" "How long have you been with the company?"\n\n**Фразы для нетворкинга:** "Hi, I don\'t think we\'ve met. I\'m [имя] from [компания]." "It\'s a pleasure to meet you." "May I introduce you to...?" "Could I give you my card?" "Let me scan your badge."\n\n**Обмен контактами:** "Can I connect with you on LinkedIn?" "Here\'s my business card." "Let\'s keep in touch." "I\'ll send you that article we talked about."\n\n**Follow-up:** В течение 24-48 часов отправьте короткое сообщение: "Hi [имя], it was great meeting you at [мероприятие]. I\'d love to continue our conversation about [тема]. Would you be available for a coffee next week?"\n\n**Темы, которых избегать:** Политика, религия, личные финансы, проблемы со здоровьем, спорные темы и глубоко личные вопросы. Если сомневаетесь — держитесь лёгкого и профессионального тона.\n\n**Советы:** Слушайте больше, чем говорите. Задавайте открытые вопросы. Улыбайтесь и поддерживайте зрительный контакт. Запоминайте имена — повторяйте их при знакомстве. Не проверяйте телефон во время беседы.\n\nSmall talk — это навык, который улучшается с практикой. Чем больше вы это делаете, тем естественнее это становится.',
          vocab: [
      ...
      },
      {
        ...
        reading: {
          ...
          textRu: 'Собеседование на английском может пугать, но с подготовкой вы сможете представить себя уверенно и профессионально. Ваше резюме получает вам собеседование; ваша презентация получает вам работу.\n\n**Структура резюме (CV):** Профессиональное CV включает: контактную информацию, профессиональное резюме, опыт работы, образование, навыки и, по желанию, рекомендации. Уложитесь в 1-2 страницы. Используйте чистый, профессиональный формат.\n\n**Профессиональное резюме (Summary):** 2-3 предложения в начале. "Marketing professional with 7 years of experience in digital campaigns. Proven track record of increasing engagement by 40%. Seeking a senior role in a dynamic company."\n\n**Опыт работы:** Перечисляйте в обратном хронологическом порядке. "Marketing Manager, ABC Corp (2020-Present). Led a team of 8. Increased social media engagement by 40%. Launched 3 successful product campaigns."\n\n**Типичные вопросы на собеседовании:**\n- "Tell me about yourself." — Дайте краткое профессиональное резюме, не историю жизни.\n- "Why do you want to work here?" — Покажите, что вы изучили компанию.\n- "What are your strengths?" — Приведите конкретные примеры.\n- "What are your weaknesses?" — Будьте честны, но покажите развитие.\n- "Where do you see yourself in 5 years?" — Покажите амбиции, согласованные с компанией.\n\n**Метод STAR:** Для поведенческих вопросов используйте STAR: Situation (ситуация/контекст), Task (ваша задача), Action (что вы сделали), Result (результат). "In my previous role (Situation), I was tasked with improving sales (Task). I implemented a new CRM system and trained the team (Action). Sales increased by 25% in six months (Result)."\n\n**О сильных сторонах:** "One of my key strengths is..." "I excel at..." "My colleagues would describe me as..." Всегда подкрепляйте утверждения примерами.\n\n**О слабых сторонах:** Выберите реальную, но не критичную слабость и покажите улучшение. "I used to struggle with public speaking, so I joined Toastmasters. Now I present confidently to large groups."\n\n**Задавание вопросов:** Всегда готовьте вопросы: "What does a typical day look like?" "What are the biggest challenges in this role?" "How does the team measure success?"\n\n**Follow-up:** Отправьте письмо с благодарностью в течение 24 часов: "Thank you for your time today. I enjoyed learning more about the role and am very interested in joining your team."\n\nБудьте искренними, будьте подготовленными и проявляйте энтузиазм. Уверенность приходит от подготовки.',
          vocab: [
