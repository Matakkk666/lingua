  ...
  const COURSES = [
    {
      ...
      tagline: 'Говорите с первого дня с адаптивным AI-репетитором.',
      level: 'Начальный',
      category: 'beginner',
      duration: '8 недель',
      lessons: 24,
      ...
      accent: 'mint',
      art: ['#D6EBDC', '#BFE3CE'],
      highlights: ['Оценка произношения в реальном времени', 'Ролевые сцены: кафе и путешествия', 'Ежедневные 15-минутные разговоры']
    },
    {
      id: 'c-fluent',
      title: 'Путь к свободной речи',
      tagline: 'Естественная беглость через AI-диалоги.',
      level: 'Средний',
      ...
      accent: 'lavender',
      art: ['#E5DAF0', '#CDBCE6'],
      highlights: ['Адаптивная сложность', 'Лаборатория идиом и фразовых глаголов', 'Еженедельные разговорные отзывы']
    },
    {
      id: 'c-business',
      title: 'Бизнес-английский Pro',
      tagline: 'Переговоры, презентации и лидерство с уверенностью.',
      level: 'Продвинутый',
      category: 'business',
      duration: '10 недель',
      lessons: 30,
      ...
      accent: 'dustyPink',
      art: ['#F2DCDC', '#E9C4C4'],
      highlights: ['AI-собеседования и питчи', 'Полировка email и отчётов', 'Тренировка деловой лексики']
    },
    {
      id: 'c-kids',
      title: 'Маленькие голоса',
      tagline: 'Весёлый английский для любопытных детей 6–12 лет.',
      level: 'Дети 6–12',
      category: 'kids',
      duration: '16 недель',
      lessons: 48,
      ...
      accent: 'cream',
      art: ['#FBF1DD', '#F3E2B8'],
      highlights: ['Интерактивные главы-истории', 'Мягкая обратная связь по голосу', 'Система наклеек-наград']
    },
    {
      id: 'c-exam',
      title: 'Мастерство IELTS',
      tagline: 'Подготовка к баллу 7+ с AI-оценкой эссе.',
      level: 'Продвинутый',
      category: 'advanced',
      duration: '14 недель',
      lessons: 42,
      ...
      accent: 'lavender',
      art: ['#E0E8F2', '#C2D2E8'],
      highlights: ['Мгновенная оценка письма', 'Симулятор устных ответов', 'Тренировка слабых мест']
    },
    {
      id: 'c-grammar',
      title: 'Основы грамматики',
      tagline: 'Освойте скелет английского с адаптивными упражнениями.',
      level: 'Начальный',
      category: 'beginner',
      duration: '6 недель',
      lessons: 18,
      ...
      accent: 'mint',
      art: ['#DCEBE3', '#C2DBC9'],
      highlights: ['Распознавание ошибок', 'Интервальное повторение', 'Контекстные упражнения']
    },
    {
      id: 'c-accent',
      title: 'Лаборатория акцента',
      tagline: 'Улучшите произношение с AI-анализом по кадрам.',
      level: 'Средний',
      category: 'intermediate',
      duration: '8 недель',
      lessons: 22,
      ...
      accent: 'dustyPink',
      art: ['#F0E2EA', '#E2C7D6'],
      highlights: ['Анализ на уровне фонем', 'Визуализатор интонации', 'Ежедневные упражнения на подражание']
    },
    {
      id: 'c-creative',
      title: 'Студия креативного письма',
      tagline: 'Пишите лучшие истории с AI-соавтором.',
      level: 'Продвинутый',
      category: 'advanced',
      duration: '10 недель',
      lessons: 28,
      ...
      accent: 'cream',
      art: ['#F4E7D8', '#EAD0A8'],
      highlights: ['Предложения по стилю и тону', 'Еженедельная обратная связь', 'Создание портфолио']
    }
  ];
